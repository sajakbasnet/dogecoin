...
(function (factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    // Node/CommonJS:
    factory(require('jquery'), require('angular'), require('./jquery.fileupload-image'), require('./jquery.fileupload-audio'), require('./jquery.fileupload-video'), require('./jquery.fileupload-validate'));
  } else {
    factory();
  }
})(function () {
  ...
  angular.module('blueimp.fileupload', []) // The fileUpload service provides configuration options
  // for the fileUpload directive and default handlers for
  // File Upload events:
  .provider('fileUpload', function () {
    var scopeEvalAsync = function scopeEvalAsync(expression) {
      var scope = angular.element(this).fileupload('option', 'scope'); // Schedule a new $digest cycle if not already inside of one
      // and evaluate the given expression:

      scope.$evalAsync(expression);
    },
        addFileMethods = function addFileMethods(scope, data) {
    ...
    $config = this.defaults = {
      handleResponse: function handleResponse(e, data) {
  ...
  .controller('FileUploadController', ['$scope', '$element', '$attrs', '$window', 'fileUpload', '$q', function ($scope, $element, $attrs, $window, fileUpload, $q) {
    var uploadMethods = {
      ...
      option: function option(_option, data) {
        if (arguments.length === 1) {
          return $element.fileupload('option', _option);
        }

        $element.fileupload('option', _option, data);
      },
    ...
    angular.extend($scope, uploadMethods); // The fileupload widget will initialize with
