...
!function (e) {
  e(document).ready(function () {
    var s,
      ...
      o.find(".task").text(_a), o.find(".notification-text").text(t), o.removeClass("hide success"), l && o.addClass(l), s && clearTimeout(s), s = setTimeout(function () {
        o.addClass("hide");
      }, 3e3);
    },
        t = function t() {
      var s = e("#new-task").val();
      if ("" == s) e("#new-task").addClass("error"), e(".new-task-wrapper .error-message").removeClass("hidden");else {
    ...
    e(".add-task-btn").click(function () {
      ...
      e(this).attr("title", l), s.hasClass("completed") ? a(t, "marked as Incomplete.") : a(t, " marked as complete.", "success"), s.toggleClass("completed");
      ...
      e("#todo-list .task").addClass("completed"), e("#mark-all-incomplete").removeClass("move-down"), e(this).addClass("move-up"), a("All tasks", "marked as complete.", "success");
    }), e("#mark-all-incomplete").click(function () {
      e("#todo-list .task").removeClass("completed"), e(this).addClass("move-down"), e("#mark-all-finished").removeClass("move-up"), a("All tasks", "marked as Incomplete.");
    });
  });
}(jQuery);