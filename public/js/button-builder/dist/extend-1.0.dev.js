...
function setColor() {
  ...
  var btnSelector = "." + strTrim.split(" ").join('.'); //alert(btnClass);
  ...
  $(".custom-button-color input").each(function () {
    var colorValue = $(this).val(); //alert(colorValue);
  ...
  var btnGradientHover = "background-image: linear-gradient(to bottom, " + "#" + bottomColor + "," + " " + "#" + bottomColor + ");"; // Setting CSS
...
(function ($) {
  ...
  setColor(); // Show hide border options
  ...
  $(colorInput).each(function () {
    var defautColor = $(this).val(); //alert(defautColor);
