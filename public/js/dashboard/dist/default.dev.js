...
var options = {
  series: [{
    name: "Series 1",
    data: [[1327359600000, 6], [1327446000000, 20], [1327532400000, 15], [1327618800000, 40], [1327878000000, 18], [1327964400000, 20], [1328050800000, 18], [1328137200000, 23], [1328223600000, 18], [1328482800000, 35], [1328569200000, 30], [1328655600000, 55], [1328742000000, 0]]
  }],
  chart: {
    height: 145,
    type: 'area',
...
chart.render(); // earning chart end
// weekly chart start
...
}, _defineProperty(_options, "states", {
  hover: {
    filter: {
      type: 'darken',
      value: 1
...
chart.render(); // transaction chart end
// yearly chart start
...
var options = {
  ...
  series: [{
    name: "Series 1",
    data: [[1486771200000, 1], [1486857600000, 12], [1486944000000, 8], [1487030400000, 20]]
  }],
  grid: (_grid = {
    yaxis: {
      lines: {
  ...
  }, _defineProperty(_grid, "yaxis", {
    lines: {
      show: false
    }
  }), _defineProperty(_grid, "padding", {
    left: -20,
    right: 0,
    top: -30,
    bottom: 0
