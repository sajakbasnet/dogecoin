...
var chart = new ApexCharts(document.querySelector("#sales-state-chart"), options);
chart.render(); // sales chart end
//sales small  chart-1 start

new Chartist.Bar('.sales-small-1', {
  labels: ['M', 'T', 'W', 'T', 'F', 'S', 'M'],
  series: [[4, 9, 8, 10, 7, 12], [10, 5, 6, 4, 7, 2]]
}, {
  stackBars: true,
  chartPadding: {
    top: -15,
...
chart.render(); // invoice overviwe chart end
...
chart.render(); //sales-state chart end
// revenue chart start
...
chart.render(); // revenue chart end
