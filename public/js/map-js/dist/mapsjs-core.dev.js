...
(function () {
  ...
  function Ub(a, b, c, d, e) {
    for (var f = c.length, g = f, h, k, l, m = c[0], n = 0, q = 0, t = 0, u = d / 2 || 0, y = e ? 1 : 3; 1 != n && g > y;) {
      ...
      l = c[g ? g - 1 : (f + (g - 1)) % f];
      k = c[g ? g - 2 : (f + (g - 2)) % f];
      if (d >= a - u && d <= a + u && h >= b - u && h <= b + u || k >= a - u && k <= a + u && l >= b - u && l <= b + u) n = 1;else if (!n && d === a) k === a && (h < b && l > b || h > b && l < b) || (m <= a && k > a || m >= a && k < a) && (h >= b ? ++q : ++t), n = Rb(b, h, l, u) && Sb(a, b, d, h, k, l) <= u ? 2 : 0;else if (!n && Rb(a, d, k, u)) {
  ...
  gc.prototype.Gf = function (a, b, c) {
    ...
    if (b /= 6371000.79) a *= Ib, e = this.lat * Ib, f = this.lng * Ib, g = e + b * yb(a), h = g - e, d = sb(zb(g / 2 + Fb) / zb(e / 2 + Fb)), d = D(h / d) ? yb(e) : h / d, k = b * wb(a) / d, rb(g) > Eb && (g = 0 < g ? Db - g : -(Db + g));
  ...
  function wc() {
    var a, b, c;
    if (!Ta(nc)) if ("file:" === window.location.protocol && -1 < navigator.userAgent.toLowerCase().indexOf("firefox") && 128 <= window.location.href.length) nc = !1;else {
  ...
  function Qc() {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == Jc.indexOf("Presto") && (a = function a() {
  ...
  function kd(a, b) {
    if (a.G == Yc) if (a.b) {
      ...
      if (c.a) {
        for (var d = 0, e = null, f = null, g = c.a; g && (g.g || (d++, g.a == a && (e = g), !(e && 1 < d))); g = g.next) {
          e || (f = g);
        }
  ...
  function $c(a, b, c) {
    if (a.G == Yc) {
      if (a == c) b = bd, c = new TypeError("Promise cannot resolve to itself");else {
        var d;
        if (c) try {
          d = !!c.$goog_Thenable;
        } catch (e) {
  ...
  Xc.prototype.o = function () {
    for (var a = null; a = ld(this);) {
      md(this, a, this.G, this.i);
    }
  ...
  function md(a, b, c, d) {
    if (c == bd && b.b && !b.g) for (; a && a.f; a = a.b) {
      a.f = !1;
    }
    if (b.a) b.a.b = null, rd(b, c, d);else try {
  ...
  Dd.prototype.add = function (a, b, c, d, e) {
    ...
    a || (a = this.a[f] = [], this.b++);
    var g = Ed(a, b, d, e);
    -1 < g ? (b = a[g], c || (b.wd = !1)) : (b = new Bd(b, this.src, f, !!d, e), b.wd = c, a.push(b));
    return b;
  };
  ...
  Xd.prototype.preventDefault = function () {
    ...
    var a = this.b;
    if (a.preventDefault) a.preventDefault();else if (a.returnValue = !1, Vd) try {
  ...
  function ie(a, b, c, d, e) {
    ...
    if (!a) return !1;
    if (a = de(a)) if (b = a.a[b.toString()], a = -1, b && (a = Ed(b, c, !!d, e)), c = -1 < a ? b[a] : null) return je(c);
    return !1;
  }
  ...
  function ke(a, b, c, d) {
    var e = !0;
    if (a = de(a)) if (b = a.a[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
      var f = b[a];
  ...
  p.dispatchEvent = function (a) {
    ...
    var c = this.ph,
        d = a.type || a;
    if (ra(a)) a = new Bc(a, c);else if (a instanceof Bc) a.target = a.target || c;else {
      var e = a;
      a = new Bc(d, c);
      Ca(a, e);
    }
  ...
  function Fe(a, b, c) {
    ...
    if (c) for (a = Ee(a), c = Ee(b), d = c.length; d--;) {
  ...
  function Re(a, b, c) {
    if (!c || a[0] | b[0]) for (var d = a.length, e = b.length, f = lb(d, e), g, h = 1, k = 1 + c; h < f; h += k) {
  ...
  function fc(a, b) {
    ...
    var c = 1,
        ...
        e,
        f = null;
    if (0 < d) for (e = a[0], f = Xe(e, e, b); c < d; c++) {
  ...
  function Ye(a, b) {
    ...
    var c = 3,
        d = a.length,
        e;
    if (0 < d) for (e = new G(a[0], a[1], a[0], a[1]); c < d; c += 3) {
      e.b(a[c], a[c + 1], b, e);
    }
    return e;
  }
  ...
  function Ze(a, b) {
    ...
    var c = 1,
        d = a.length,
        e;
    if (0 < d) for (e = new G(a[0].ka, a[0].ga, a[0].ja, a[0].ha); c < d; c++) {
      e.wb(a[c], b, e);
    }
    return e;
  }
  ...
  $e.prototype.remove = function (a) {
    ...
    if (d && (b = d.indexOf(a), -1 !== b && (d.splice(b, 1), !d.length))) {
      ...
      for (var e = this.a; (d = c.a) && !(c.Y || c[0] || c[1] || c[2] || c[3]);) {
  ...
  function df(a, b, c) {
    var d, e;
    if (d = a.b) for (e = 4; e--;) {
      if (e % 3 ? b[e] >= d[e] : b[e] <= d[e]) if (c) d[e] = b[e];else {
        a.b = null;
        break;
      }
    }
  ...
  function cf(a, b) {
    ...
    if (b) {
      if (d = b, d !== c) for (c = d; d = d.a;) {
        if (d.Y || 3 > !d[0] + !d[1] + !d[2] + !d[3]) c = d;
      }
    } else for (; !c.Y && 2 < !c[0] + !c[1] + !c[2] + !c[3];) {
      if (d = c[0] || c[1] || c[2] || c[3]) c = d;else break;
    }
  ...
  function gf(a, b, c, d, e, f, g) {
    ...
    var m = b[8],
        ...
        u = b[6],
        y;
    if (l) if (h = l.length, d > k || f < n || e > q || g < u) for (; h--;) {
      k = l[h], n = k[3], q = k[0], u = k[1], y = k[2], n > f || u < d || q > g || y < e || c.push(k);
    } else for (; h--;) {
      c.push(l[h]);
    }
  ...
  jf.prototype.S = function () {
    ...
    if (!this.a) {
      ...
      if (!this.b && (k = (g = this.g).length)) {
        ...
        for (f = 0; k--;) {
          h = g[k], a = lb(a, h[0]), d = lb(d, h[3]), e = mb(e, h[2]), f = mb(f, h[1]);
        }
  ...
  jf.prototype.remove = function (a) {
    var b,
        c = !1;
    if (a.a) c = this.i.remove(a), this.f = null;else if (a = (b = this.g).indexOf(a), c = 0 <= a) b.splice(a, 1), this.b = null;
  ...
  function lf(a, b, c, d, e) {
    ...
    var f = a.length,
        ...
        k,
        l;
    if (f) for (k = c + 360, l = e + 360; f--;) {
      g = a[f], mf(g, b, c, d, e) ? h.push(g) : mf(g, b, k, d, l) && h.push(g);
    }
    return h;
  }
  ...
  F.prototype.S = function () {
    ...
    if (!(a = this.a)) {
      ...
      var b = a.length,
          ...
          k = x,
          l = We;
      if (3 <= b) for (d = e = a[0], f = g = a[1], k = new G(d, f, e, g); c < b; c += 3) {
        d = a[c - 3];
        f = a[c - 2];
        e = a[c];
        g = a[c + 1];
  ...
  function pf(a, b, c) {
    for (var d = a.length, e = !(d % 3), f; e && d;) {
      e = !(D(a[--d] = Yb((f = a[d]) === A ? 0 : f)) || D(a[--d] = Xb(a[d])) || D(a[--d] = Wb(a[d])));
    }
  ...
  F.prototype.pa = function (a) {
    var b = this === a,
        c,
        d;
    if (!b && (b = B(a, F))) for (c = this.na, a = a.na, b = (d = c.length) === a.length; b && d--;) {
      b = c[d] == a[d];
    }
    return b;
  };
  ...
  function xf(a) {
    var b = a.m,
        ...
        h,
        k;
    if (!b) for (b = a.m = new jf(), c = 0, a = a.na, d = a.length, e = 0; e < d; e += 3) {
      f = a[e];
      g = a[e + 1];
  ...
  function yf(a, b) {
    ...
    for (g = 0; g < f; g++) {
      d = c[g], d = d.ke, h = 3 * d, d > k + 1 && (m = [e[h], e[h + 1]], l.push(m)), k = d, m.push(e[h + 3], e[h + 4]);
    }
    ...
    if (a.b) {
      ...
      for (g = 0; g < f; g++) {
        if (m = l[g], k = m.length) {
          ...
          for (c = 0; c < k; c += 2) {
            h = m[c], n = m[c + 1], d.push(h, n), q = m[c - 1], c && ac(n, q) && (e.push(d), d = [], q += 0 > q ? 360 : -360, d.push(m[c - 2], q, h, n));
          }
  ...
  function zf(a) {
    ...
    if (a) {
      ...
      for (e = B(a, zf); b--;) {
        if (c = Bf[b], a.hasOwnProperty(c)) if (d = a[c], e) this[c] = d;else {
  ...
  function Ff(a) {
    ...
    if (a) {
      ...
      for (c in a) {
        c in this && (d = a[c], d !== this[c] && ("fillColor" === c || 0 < (d = +d)) && (this[c] = d));
      }
  ...
  function Kf(a, b, c, d) {
    ...
    for (g = 0; g < f; g++) {
      h = b[g], h.length && e.push(Lf(a, h, c, d));
    }
  ...
  Pf.prototype.S = function () {
    ...
    if (!(a = this.a)) {
      a = x;
      var b, c;
      if (this.ma.length) for (a = this.ma[0].S(), c = 1; c < this.ma.length; c++) {
  ...
  function Qf(a, b, c, d) {
    ...
    for (e = 0; e < b.length; e++) {
      if (a.c(b[e])) f.push(a.l(b[e]));else throw new C(c, d);
    }
  ...
  Pf.prototype.pa = function (a) {
    var b = this === a,
        c,
        d;
    if (!b && (b = B(a, this.constructor))) for (c = this.ma, a = a.ma, b = (d = c.length) === a.length; b && d--;) {
      b = c[d].pa(a[d]);
    }
    return b;
  };
  ...
  Pf.prototype.Lb = function (a) {
    ...
    if (c) {
      ...
      for (d = 0; d < c; d++) {
        (e = 0 < d && f) && a.push(","), b[d].Lb(a), "EMPTY" === a[a.length - 1] ? a.splice(-1 - e, 1 + e) : f = !0;
      }
  ...
  Uf.prototype.ec = function (a) {
    var b,
        ...
        e,
        f;
    if (this.m) for (c = c.ma, f = 0, e = c.length; f < e; f++) {
  ...
  function Vf(a, b, c, d) {
    ...
    if (e = Xf(a, b.$a, c, d, b.S())) {
      f = new Sf(e);
      g = b.lb;
      if (h = g.length) for (f.a = f.Ra.length; k < h; k++) {
  ...
  function Xf(a, b, c, d, e) {
    ...
    if (360 === e.ab() && 1 === b.l(!0) % 2) {
      ...
      for (h = 0; h < k; h++) {
        m = b[0][h], l[h] = new M(m.x - 2 * g.w, m.y), l[h + k] = new M(m.x - g.w, m.y), l[h + 2 * k] = new M(m.x, m.y), l[h + 3 * k] = new M(m.x + g.w, m.y), l[h + 4 * k] = new M(m.x + 2 * g.w, m.y);
      }
        ...
        for (d = c.length; d--;) {
          ...
          if (b && g) {
            ...
            for (m = b; m.next; m = m.next) {
              if (!m.bb) for (n = g; n.next; n = n.next) {
                !n.bb && (t = cg(m.next), T = cg(n.next), q = dg(m, t, n, T, a)) && (q = a.Kh, J = a.Zf, u = a.Hi, y = a.Ii, q = ag(u, y, null, null, null, null, 1, 0, 0, q), eg(q, m, t), t = ag(u, y, null, null, null, null, 1, 0, 0, J), eg(t, n, T), q.df = t, t.df = q);
              }
            }
  ...
  function jg(a, b, c) {
    ...
    for (m = c.length; d < m; d++) {
      k = c[d].x, l = c[d].y, k > g ? g = k : k < e && (e = k), l > h ? h = l : l < f && (f = l);
    }
  ...
  function Yf(a, b) {
    ...
    for (h = 0; h < g; h += 3) {
      k = d[h], l = d[h + 1], m || 180 != rb(l) || (f.push(k), f.push(l), f.push(k), f.push(-l), m = !0), f.push(k), f.push(l);
    }
    ...
    if (b.g()) {
      ...
      -1 !== d && (g = e[d - 2], f = e[d - 1], h = e[d % k], m = e[(d + 1) % k], 180 !== rb(g) && 180 !== rb(h) && (l = rb(h - g), k = rb(m - f), k += 180 < k ? -360 : 0, m = rb(180 - m), m += 180 < m ? -360 : 0, k && m && (l /= rb(k) / rb(m), g = h + (h > g ? -l : l), f = 0 < f ? 180 : -180, e.splice(d, 0, g, f, g, -f))));
      d = e;
    }
  ...
  Uf.prototype.Tb = function () {
    var a = this.Ca(),
        ...
        d;
    jb(Uf.prototype.Tb);
    if (this.m) for (b = a.ma, d = b.length, a = [], c = 0; c < d; c++) {
  ...
  function kg(a, b) {
    for (var c = [], d = Number.POSITIVE_INFINITY, e = -1, f, g = a.length, c = 0; c < g; c += 2) {
      f = rb(a[c + 1] - b), f += 180 < f ? 360 - f : f, f < d && (d = f, e = c);
    }
  ...
  function ng(a) {
    var b = a.o,
        ...
        e = 0,
        f = new F();
    if (90 === rb(c)) for (c = b.Gf(0, d, !0).lat; 360 > e; e += 120) {
      f.o(c, e - 180, A);
    } else for (a = a.a, a = 360 / a; 360 > e; e += a) {
      f.c(b.Gf(e, d, !0));
    }
    b = new E(f);
    0 > c && b.i(cc.SOUTH);
  ...
  pg.prototype.c = function (a) {
    var b = this.c,
        ...
        e;
    if (B(a, og)) {
      if (c = a.ma, d = c.length) for (e = 0; e < d; e++) {
        qg(c[e], b);
  ...
  pg.prototype.ec = function (a) {
    ...
    var c,
        d = [];
    if (this.m) for (b = b.ma, c = b.length; c--;) {
      rg(this, b[c], a, d);
    } else rg(this, b, a, d);
    return d.length ? d : A;
  };
  ...
  function zg(a, b, c, d, e) {
    ...
    for (g = 1; g <= h; g++) {
      (c = a.next()) ? (f = +c) !== f ? tg(a, c, "number") : 1 === g ? d[e + 1] = f : 2 === g ? d[e + 0] = f : 3 === g && (d[e + 2] = f) : tg(a, c);
    }
  ...
  function ug(a) {
    ...
    if (b !== Eg) {
      ...
      d | e && a.next();
      c = yg(a);
      if ("EMPTY" === c) a.next(), (d = b[1]) ? f = new d([]) : b !== Gg && (f = new F([]), b === Fg && (f = new E(f)));else if ("(" === c) {
        f = b[0];
        b = b[1];
        var g, h;
  ...
  function yg(a) {
    ...
    if (b === A) {
      ...
      if (Lg[b.a()]) b = b.next(), b = b === Mg ? "" : String.fromCharCode(b);else {
        b.m();
  ...
  Vg.prototype.forEach = function (a, b, c) {
    ...
    for (e in this.Y) {
      d = this.Y[e], (c ? c(e, d.data, d.size) : 1) && a.call(b, e, d.data, d.size);
    }
  };
  ...
  Vg.prototype.Ea = function (a) {
    ...
    for (c in this.Y) {
      b = this.Y[c], (a ? a(c, b.data, b.size) : 1) && Xg(this, this.Y[c], !0);
    }
  };
  ...
  N.prototype.o = function (a, b, c, d) {
    ...
    g = k.get(f);
    g && g.valid || d || this.a[f] || (m[f] = dh, h = function h(d) {
      var h;
      ...
      d && h < e.MAX_STORE_TIME ? e.Ga(d.raw, function (h) {
        ...
        k.add(f, g, e.v(d));
        Rg(e, g);
      }) : (h && n.remove(f), g = void 0, e.a[f] = e.requestInternal(a, b, c, function (d, h) {
  ...
  N.prototype.D = function () {
    ...
    for (a in this.a) {
      this.a[a].cancel(), delete this.a[a];
    }
  };
  ...
  eh.prototype.c = function (a, b, c, d, e) {
    ...
    return this.ea(a, b, c, function (e) {
      for (var h = [], k, l, m = e.length; m--;) {
        l = e[m], l.Di = f.getTileKey(a, b, c), l.ia(f), k = l.sb(), (B(l, fh) || k.getState() === k.Pc.READY) && h.push(e[m]);
      }
  ...
  mh.prototype.B = function (a) {
    ...
    if (a !== b) {
      ...
      if (a <= this.max) this.min = a, this.dispatchEvent(new Ne(this.a.Uf, a, b)), this.l();else throw new C(mh.prototype.B, 0, "min > max");
    }
  ...
  mh.prototype.s = function (a) {
    ...
    if (a !== b) {
      ...
      if (a >= this.min) this.max = a, this.dispatchEvent(new Ne(this.a.Tf, a, b)), this.l();else throw new C(mh.prototype.s, 0, "max < min");
    }
  ...
  nh.prototype.o = function (a, b, c, d, e, f) {
    ...
    d || (g = {});
    b = rh(this, a, b, c, e);
    if (a = b.length) for (d || b.sort(th), c = a; c--;) {
      e = b[c], d || (g[l.A.apply(l, e)] = !0), e[3] = +d, (k = m.apply(l, e)) && h.push(k);
    }
  ...
  Ca(Lh.prototype, {
    ...
    se: function se(a) {
      var b, c, d;
      a = a.type;
      if (d = this.Zg[a]) b = this.Hf, c = b[0], c || (c = b[0] = new Ch(), this.Eb(za(Ac, c)), Wa(this.Ed) || c.importScripts(w.Object.keys(this.Ed))), b = c, b.f[a] || (b.f[a] = d, Ih(b, "1", [a, sa(d) ? d + "" : d]).then(sc, z(b.l, b, a)));else throw new kc(this.se, 'Unknown type "' + a + '"');
      return c;
    },
    ye: function ye() {},
    md: function md(a, b) {
      ...
      if (d) {
        if (b !== d) throw new kc(this.md, 'Type "' + a + '" is already registered');
      } else c[a] = b;
    },
    importScripts: function importScripts(a) {
  ...
  function hi(a) {
    ...
    if (!b) if (a in ji) b = ii[a] = a;else {
      ...
      for (; b-- && !f;) {
        c = ki[b], e = c + d, f = e in ji;
      }

      f && (li = c);
      if (b = f ? e : null) ii[a] = b;else throw Error("Could not find any variant of CSS property [" + a + "]");
    }
    return b;
  }
  ...
  function Ai(a, b, c) {
    a = a.Y.length;
    var d;
    if (c) d = a;else if (D(d = 0 > (d = +b) ? mb(0, a + d) : lb(a, d))) throw new ec(zi, b, [0, a - 1]);
    return d;
  }
  ...
  Ji.prototype.Ia = function () {
    var a = this.a,
        ...
        l = [Qi];
    if (c) for (; f < d; f++) {
      if (h = a.get(f).getCopyrights(c, b)) for (g = 0; g < h.length; g++) {
  ...
  fj.prototype.ca = function (a, b, c, d, e, f) {
    ...
    if (d >= k.min && d <= k.max && (l = this.fg(a, d, e, f), m = l.markers, a = m.length)) {
      ...
      for (k = 0; k < a; k++) {
        this.wg.apply(this, d[k]);
      }
    }

    return !l || l.requested && l.requested === l.total || !l.requested && m.length === l.total ? ij.DONE : ij.PENDING;
  };
  ...
  jj.prototype.Ma = function (a, b, c) {
    ...
    if (this.f) {
      ...
      for (b += g.top; (l = m = d.elementFromPoint(a, b)) && l !== f && l !== e && m !== n;) {
      ...
      if (k) for (b = k.length; b--;) {
        a = k[b], a.style.removeProperty(lj), ra(a.bg) && a.style.setProperty(lj, a.bg, a.$h);
      }
    }
  ...
  pj.prototype.ca = function (a, b, c, d, e, f) {
    ...
    for (h = 0; h < f; h++) {
      n = e[h];
      if (l = n.data) if (c = b.x - (y - n.x * d), m = b.y - (J - n.y * d), q.bc(l, c, m, d, d), !this.l) {
        for (t = c; (t -= u) > k;) {
          q.bc(l, t, m, d, d);
        }
  ...
  var rj,
    ...
    for (var b, c, d, e = Ra("o ms moz webkit "), f = 5; f-- && !b;) {
      b = e[f], b = (c = w[b + (b ? "R" : "r") + "equestAnimationFrame"]) && !D(c.call(window, a)) && (d = w[b + (b ? "C" : "c") + "ancelAnimationFrame"]);
    }
  ...
  Ij.prototype.ca = function (a, b, c, d, e) {
    ...
    f = this.f;
    this.f = g = {};
    if (d >= h.min && d <= h.max && (k = h.C(a, d, e), l = k.overlays, a = l.length)) for (l.sort(Se), d = this.b, e = this.Nb, ob = h.opacity, h = 0; h < a; h++) {
      m = l[h], n = m.S(), q = c.geoToPixel(n.tb()), t = c.geoToPixel(n.rb()), n = c.w, q.x >= t.x && (q.x -= n), this.g || (u = -((q.x + t.x) / n >> 1) * n), q.x += u, q.add(b), t.x += u, t.add(b), e || (q.round(), t.round()), (n = f[y = m.ta()]) ? delete f[y] : n = {
        vi: m
      }, g[y] = n, J = q.x, q = q.y, T = t.x, t = t.y, ea = T - J, la = t - q, dj(d, m.Bd() * ob), d.bc(m.Pb(), J, q, ea, la), n.Ae ? n.Ae.set(J, q, T, t) : n.Ae = new qh(J, q, T, t), this.c.push(n);
    }
  ...
  Ij.prototype.Ma = function (a, b, c) {
    for (var d = this.c, e = d.length, f, g, h; e--;) {
      if (f = d[e], g = f.Ae, g.a(a, b)) if (f = f.vi, h) h.push(f);else if (h = [f], c) break;
    }
  ...
  function ck(a) {
    var b;
    if (0 < a.T.length) b = a.T[0].max, a.be = a.T[0].min, a.Zd = b;else {
      b = a.ih.zoom;
      var c = b.max;
      a.be = b.min;
      a.Zd = c;
  ...
  O.prototype.Ub = function () {
    ...
    for (h = this.m.length; h--;) {
      l = this.m[h], B(l, Cj) && l.clear();
    }

    if (q) {
      if (g) for (; g;) {
        h = e - g, q.ca(c, b, m, h, !0, a), --g;
      }
      if (n && this.jc) for (l = 1; l <= n && (h = e + l, m.Ja(h), g = this.v(2, 0), m.Ja(e), !q.ca(g, b, m, h, !0, a)); l++) {
        ;
      }
    }
  ...
  O.prototype.jh = function (a, b, c, d, e, f, g) {
    ...
    for (y = 0; y < m; y++) {
      f === n.Yf ? (T = y % k, J = Math.floor(y / k)) : f === n.Qf && (T = Math.floor(y / l), J = y % l), q = h[T].Fa[J], t = h[T].Yc, q && (q = q.ca(a, b, this.a, c, d, e), q === ij.ACTIVE && (this.Vb = Infinity), q !== ij.DONE || t[J] || (zk(this, this.T[J]), t[J] = !0), t[J] || (u = !1));
    }
  ...
  O.prototype.s = function (a, b) {
    ...
    }, l, void 0, this.o.Be)), this.c.reset());
  };
  ...
  P.prototype.forEach = function (a, b, c) {
    var d, e, f, g;
    if (this.b) for (d = this.O, e = d.nextSibling, f = 0; e !== d;) {
      g = e.nextSibling, a.call(c, e, f++, this), b && B(e, P) && e.forEach(a, b, c), e = g;
    }
  };
  ...
  function Mk(a, b, c, d, e) {
    ...
    if (b.c) {
      ...
      for (f = 0; f < c; f++) {
        ...
        for (var k = nb(d), l = h, m = void 0; (m = l.Ga <= k && l.ea >= k) && (l = l.Da);) {
          ;
        }
  ...
  function Qk(a) {
    ...
    for (a.a = null; d < c.length;) {
      b = c[d], b.rg ? c.splice(d, 1) : d++;
    }
  ...
  function fg(a, b, c) {
    ...
    c = c || a.y;
    d = ag(-137438953472, c);
    Array.isArray(b) ? (k = 0, g = b[k], l = function l() {
      return b[++k];
    }) : (m = g = b, l = function l() {
      return m = m.next;
    });
  ...
  function eg(a, b, c) {
    for (b = b.next; b !== c && b.alpha <= a.alpha;) {
      b = b.next;
    }
  ...
  function Xk(a, b, c, d, e) {
    var f,
        ...
        y;
    if (u) for (; q < e;) {
      t = a[q++], f = t.x, t = t.y, y = ((f - k) * (m - k) + (t - l) * (n - l)) / u, f = 0 > y ? Wk(f, t, k, l) : 1 < y ? Wk(f, t, m, n) : Wk(f, t, k + y * (m - k), l + y * (n - l)), f > g && (g = f, h = q - 1);
    } else for (; q < e;) {
      t = a[q++], f = t.x, t = t.y, f = Wk(f, t, k, l), f > g && (g = f, h = q - 1);
    }
  ...
  Yk.prototype.ca = function (a) {
    ...
    if (this.c < this.f) {
      c = this.a;
      if (d = c.length) for (a.width = a.height = this.b, b.clearRect(0, 0, this.b, this.b), e = this.g, f = 0; f < d; f++) {
        if (h = c[f], g = h.ta(), l = (k = e[g]) ? k.b : h.getGeometriesForTile(this)) {
          if (k) h.j().b(this.c) && (k.a = Hf(h, l)), k = k.a;else {
            ...
            for (var q = h.B ? 2 : 0, t = m.length, u = void 0, y = u = void 0, J = void 0; t--;) {
              if (u = m[t], u !== If) for (y = u.Ra, u = y.length; u--;) {
                J = y[u], 4 < J.length && (y[u] = Xk(J, .36, q || 0, 0, J.length - 1));
              }
            }
          ...
          if (k) {
            ...
            for (g = 0; g < l.length; g++) {
              m.call(this, h, l[g], h.Na(), b);
            }

            if (l = h.getLabels(this)) for (h = b, g = l.length, m = m = t = q = q = void 0; g--;) {
              for (q = l[g], m = q.size, h.font = m + "px " + q.font, h.fillStyle = q.color, h.textAlign = "center", h.translate(q.x, q.y), h.rotate(q.angle), m = q.lineHeight || 1.375 * m, q = q.lines, t = q.length; t--;) {
  ...
  Yk.prototype.T = function (a, b, c, d) {
    var e = c.c,
        ...
        k = this.b,
        l = this.F;
    if (b === If) e && (gl(d, c), d.fillRect(0, 0, k, k));else if (f && el(d, c, this.Wb), c.a && (g = a.s) && (h = c.lineWidth, g.fd || (g = null)), a = b.b, a === Lb) {
  ...
  function fl(a, b, c, d, e, f, g, h, k) {
    ...
    h = h || 0;
    k === A && (k = q.length);
    if (e && a === If) b.fillRect(0, 0, f, f);else if (k > h) {
      b.beginPath();

      for (f = h; f < k; f++) {
        m = q[f];
        n = m.length;
        if (m === Tf) b.moveTo(t, t), b.lineTo(t, g), b.lineTo(g, g), b.lineTo(g, t);else for (l = m[0], b.moveTo(l.x, l.y), h = 1; h < n; h++) {
  ...
  function hl(a, b, c, d, e, f) {
    ...
    for (k = c.length; k-- > f;) {
      ...
      if (q = m = l.length) {
        ...
        for (t = 0; --q;) {
          t += n[q].distance(n[q - 1]);
        }

        q = (n = t) >= d;
      }

      if (q) for (q = lb(pb(n / d), 1E3), q = n / (q + 1), t = q / 2; --m;) {
        for (y = (J = l[m]).distance(T = l[m - 1]); t <= u + y;) {
          la = J.x + (T.x - J.x) * (ea = (t - u) / y), ea = J.y + (T.y - J.y) * ea, a.a(la, ea) && (b.save(), b.translate(la, ea), b.rotate(-Ab((T.y - J.y) / (J.x - T.x)) + (J.x < T.x ? ob : -ob)), b.beginPath(), b.moveTo(-g, -e), b.lineTo(0, e), b.lineTo(g, -e), b.lineTo(0, -h), b.closePath(), b.fill(), b.restore()), t += q;
        }
        ...
        for (f = k.length; f--;) {
          ...
          if (!(u = m && l === If) && (u = m || q)) {
            ...
            for (var Ja = l.length, Jb = void 0, Sd = void 0, lk = void 0, rf = void 0, sf = void 0, ia = Jb = void 0, mk = 0, nk = 0, ia = void 0, Co = !1, rf = 0; rf < Ja; rf++) {
              if (Jb = l[rf], ia = rf >= la, na = !ia && rf >= ea, Jb === Tf && J) na ? mk++ : nk++;else {
                lk = Jb.length;
                il.length = 2 * lk;
                ...
                Jb = J && !ia;
                ia = ob && !ia ? 0 : T;
                if (Jb || ia) if (ia = Ub(u, y, il, ia, Jb), 2 === ia || 1 === ia) {
                  Co = !0;
                  break;
                } else if (3 === ia) if (na) mk++;else if (nk++, ea === Lb) break;
              }
            }
  ...
  function Pk(a) {
    ...
    if (Ta(this.I.crossOrigin)) a = !!this.I.crossOrigin;else {
      a = this.P(0, 0, 0);
  ...
  function Q(a, b, c) {
    ...
    b = this.l.imprint;
    if (b !== A && "object" !== _typeof(b)) throw new C(Q, 1, "imprint");
  ...
  function nl(a, b) {
    var c;
    if (a) {
      if (c = a.pixelRatio, c === A) a.pixelRatio = 1;else {
  ...
  Q.prototype.ya = function (a, b, c, d, e, f) {
    ...
    l.capture ? (m = k.ya(T, ea, c, d), n = m.getContext("2d"), m.style.width = m.width / t + "px", m.style.height = m.height / t + "px", u = new Tk(10, g), b = b.concat(q).filter(function (a) {
  ...
  Lk.prototype.f = function (a) {
    var b = this.o,
        c = 2 > b;
    a -= 0;
    if (0 <= a && 1 >= a) a !== b && (this.o = a, c && this.ua(Me.VISUAL));else throw new C(this.f, 0);
    return this;
  };
