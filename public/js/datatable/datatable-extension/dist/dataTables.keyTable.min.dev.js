...
(function (f) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (k, h) {
    k || (k = window);
  ...
  f.extend(n.prototype, {
    ...
    _clipboardCopy: function _clipboardCopy() {
      var a = this.s.dt;
    ...
    _focus: function _focus(a, b, c, d) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, m.one("draw", function () {
          ...
          if (c === o || !0 === c) this._scroll(f(k), f(h.body), i, "offset"), c = m.table().body().parentNode, c !== m.table().header().parentNode && (c = f(c.parentNode), this._scroll(c, c, i, "position"));
          this.s.lastFocus = {
            cell: g,
            node: g.node(),
            relative: {
    ...
    _shift: function _shift(a, b, c) {
      ...
      if (g) {
        ...
        0 <= j && j < h && -1 !== f.inArray(e, i) ? (a.preventDefault(), this._focus(j, e, !0, a)) : !c || !this.c.blurable ? a.preventDefault() : this._blur();
      }
    },
