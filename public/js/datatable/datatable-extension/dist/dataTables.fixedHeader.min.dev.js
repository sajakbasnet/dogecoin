...
(function (d) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (g, h) {
    g || (g = window);
  ...
  d.extend(i.prototype, {
    ...
    headerOffset: function headerOffset(b) {
      b !== k && (this.c.headerOffset = b, this.update());
      return this.c.headerOffset;
    },
    footerOffset: function footerOffset(b) {
    ...
    _matchWidths: function _matchWidths(b, a) {
      var e = function e(a) {
    ...
    _horizontal: function _horizontal(b, a) {
      var e = this.dom[b],
          c = this.s.position,
          d = this.s.scrollLeft;
      e.floating && d[b] !== a && (e.floating.css("left", c.left - a), d[b] = a);
    },
    _modeChange: function _modeChange(b, a, e) {
      var c = this.dom[a],
          f = this.s.position,
