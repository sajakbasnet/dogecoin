...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (i, l, t, s) {
    i || (i = window);
      ...
      if (e.isPlainObject(c)) {
        ...
        if (u) {
          ...
          for (g = v.length; h < g; h++) {
            f = c.createAttribute(v[h].name.replace(":", "_dt_b_namespace_token_")), f.value = v[h].value, b.setAttributeNode(f);
          }
        }
  ...
  if ("undefined" === typeof f || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) r = void 0;else {
    ...
    "undefined" !== typeof navigator && navigator.msSaveOrOpenBlob ? r = function r(a, b, d) {
      b = b || a.name || "download";
      d || (a = D(a));
      return navigator.msSaveOrOpenBlob(a, b);
    } : (k.abort = function () {}, k.readyState = k.INIT = 0, k.WRITING = 1, k.DONE = 2, k.error = k.onwritestart = k.onprogress = k.onwrite = k.onabort = k.onerror = k.onwriteend = null, r = function r(a, b, d) {
  ...
  var N = function N(a) {
    ...
    return a.newline ? a.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n";
      ...
      G = function G(a, b) {
    for (var d = F(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, h = b.fieldSeparator, g = RegExp(e, "g"), f = b.escapeChar !== q ? b.escapeChar : "\\", i = function i(a) {
      for (var b = "", c = 0, d = a.length; c < d; c++) {
        0 < c && (b += h), b += e ? e + ("" + a[c]).replace(g, f + e) + e : a[c];
      }

      return b;
    }, l = b.header ? i(c.header) + d : "", j = b.footer && c.footer ? d + i(c.footer) : "", n = [], m = 0, k = c.body.length; m < k; m++) {
      n.push(i(c.body[m]));
    }
  ...
  p.ext.buttons.copyHtml5 = {
    ...
    action: function action(a, b, d, c) {
      ...
      k = e("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(d);
  ...
  p.ext.buttons.excelHtml5 = {
    ...
    action: function action(a, b, d, c) {
      ...
      for (var b = 0, s = d.body.length; b < s; b++) {
        j(d.body[b], h);
      }
  ...
  p.ext.buttons.pdfHtml5 = {
    ...
    action: function action(a, b, d, c) {
      ...
      for (var f = 0, h = a.body.length; f < h; f++) {
        d.push(e.map(a.body[f], function (a) {
          return {
            text: "string" === typeof a ? a : a + "",
