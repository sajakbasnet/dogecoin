...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (j, m) {
    j || (j = window);
  ...
  function x(a) {
    ...
    c.on("mousedown.dtSelect", d, function (b) {
      ...
      if (j.getSelection) {
        ...
        if ((!d.anchorNode || e(d.anchorNode).closest("table")[0] === a.table().node()) && "" !== e.trim(d.toString())) return;
      }
  ...
  function s(a, c, b, d, f) {
    ...
    "os" === e ? a.ctrlKey || a.metaKey ? c[d](f).select(!g) : a.shiftKey ? "cell" === d ? v(c, f, b._select_lastCell || null) : z(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : (a = c[d + "s"]({
      selected: !0
  ...
  e.each([{
    ...
    g.ext.selector[c.type].push(function (b, a, f) {
      ...
      for (var k = 0, h = f.length; k < h; k++) {
        e = b[c.prop][f[k]], (!0 === a && !0 === e._select_selected || !1 === a && !e._select_selected) && g.push(f[k]);
      }
