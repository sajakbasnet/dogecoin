...
(function (d) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (o, n) {
    o || (o = window);
  ...
  d.extend(m.prototype, {
    ...
    _expandButton: function _expandButton(a, b, c, e) {
      for (var h = this.s.dt, g = 0, b = !d.isArray(b) ? [b] : b, f = 0, q = b.length; f < q; f++) {
    ...
    _resolveExtends: function _resolveExtends(a) {
      for (var b = this.s.dt, c, e, h = function h(c) {
  ...
  m.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      return a.name;
        ...
        h = function h(a) {
      if (d.isArray(a)) for (var f = 0, q = a.length; f < q; f++) {
        h(a[f]);
      } else "string" === typeof a ? -1 !== a.indexOf(",") ? h(a.split(",")) : (a = d.inArray(d.trim(a), e), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst);
    };
  ...
  i.Api.registerPlural("buttons().containers()", "buttons().container()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons) for (var c = m.instanceSelector(b, c._buttons), d = 0, h = c.length; d < h; d++) {
    ...
    if (this.context.length) {
      var b = new i.Api(this.context[0]),
        ...
        return c.format.header(d.innerHTML, a, d);
          ...
          h = b.table().footer() ? b.columns(c.columns).indexes().map(function (a) {
