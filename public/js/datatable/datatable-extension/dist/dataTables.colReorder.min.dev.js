...
(function (f) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (o, l) {
    o || (o = window);
  ...
  f.fn.dataTableExt.oApi.fnColReorder = function (a, b, c, e, g) {
    ...
    if (b != c) if (0 > b || b >= l) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b);else if (0 > c || c >= l) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + c);else {
      j = [];
      d = 0;
      ...
      for (h = l; d < h; d++) {
        k = a.aoColumns[d], "number" == typeof k.mData ? k.mData = n[k.mData] : f.isPlainObject(k.mData) && (i(k.mData, "_", n), i(k.mData, "filter", n), i(k.mData, "sort", n), i(k.mData, "type", n));
      }
      ...
      for (h = l; d < h; d++) {
        f(a.aoColumns[d].nTh).off("click.DT"), this.oApi._fnSortAttachListener(a, a.aoColumns[d].nTh, d);
      }
  ...
  f.extend(i.prototype, {
    ...
    _fnConstruct: function _fnConstruct() {
      ...
      if (g) {
        if (a.s.dt._bInitComplete) b = q(g), a._fnOrderColumns.call(a, b);else {
          var d = !1;
    ...
    _fnStateSave: function _fnStateSave(a) {
      ...
      if (a.aaSorting) {
        ...
        for (c = g.length; b < c; b++) {
          e = g[b]._ColReorder_iOrigCol, a.aoSearchCols[e] = d[b], a.abVisCols[e] = g[b].bVisible, a.ColReorder.push(e);
        }
      } else if (a.order) {
        ...
        for (c = g.length; b < c; b++) {
          e = g[b]._ColReorder_iOrigCol, a.columns[e] = d[b], a.ColReorder.push(e);
        }
      }
    },
    ...
    _fnMouseUp: function _fnMouseUp() {
      f(l).off(".ColReorder");
    ...
    _fnRegions: function _fnRegions() {
      ...
      for (var b = 0, c = this.s.aoTargets[0].x, e = 0, g = a.length; e < g; e++) {
        e != this.s.mouse.fromIndex && b++, a[e].bVisible && "none" !== a[e].nTh.style.display && (c += f(a[e].nTh).outerWidth(), this.s.aoTargets.push({
          x: c,
          to: b
        }));
      }
