...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (l, i) {
    l || (l = window);
  ...
  var k = e.fn.dataTable,
    ...
    this.dom = {
      ...
      list: e('<div class="dt-autofill-list">' + this.s.dt.i18n("autoFill.info", "") + "<ul/></div>"),
      dtScroll: null,
      offsetParent: null
    };
  ...
  e.extend(j.prototype, {
    ...
    _actionSelector: function _actionSelector(c) {
      var b = this,
          a = this.s.dt,
          d = j.actions,
          f = [];
    ...
    _drawSelection: function _drawSelection(c) {
      var b = this.s.dt,
          a = this.s.start,
          d = e(this.dom.start),
          f = e(c),
        ...
        for (var d = {}, f = [], e = a.fields(), g = 0, i = c.length; g < i; g++) {
          for (var j = 0, l = c[g].length; j < l; j++) {
            var o = c[g][j],
                ...
                n = k.editField;
            if (n === q) for (var k = k.mData, m = 0, p = e.length; m < p; m++) {
              var r = a.field(e[m]);
    ...
    _emitEvent: function _emitEvent(c, b) {
    ...
    _focusListenerRemove: function _focusListenerRemove() {
      var c = this.s.dt;
      c.off(".autoFill");
      e(c.table().body()).off(this.s.namespace);
      e(i.body).off(this.s.namespace);
    },
    _getPosition: function _getPosition(c, b) {
      var a = e(c),
          d,
          f,
          h = 0,
    ...
    _mousedown: function _mousedown(c) {
      var b = this,
          a = this.s.dt;
    ...
    _mouseup: function _mouseup() {
      ...
      if (!(b.row === a.row && b.column === a.column)) {
        for (var d = this._range(b.row, a.row), b = this._range(b.column, a.column), a = [], f = c.settings()[0], h = f.aoColumns, g = 0; g < d.length; g++) {
          a.push(e.map(b, function (a) {
    ...
    _range: function _range(c, b) {
      var a = [],
          d;
      if (c <= b) for (d = c; d <= b; d++) {
        a.push(d);
      } else for (d = c; d >= b; d--) {
        a.push(d);
      }
    ...
    _shiftScroll: function _shiftScroll(c) {
      var b = this,
          a = this.s.scroll,
          d = !1,
