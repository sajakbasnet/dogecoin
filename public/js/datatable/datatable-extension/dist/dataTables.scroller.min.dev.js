...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (g, j) {
    g || (g = window);
  ...
  e.extend(h.prototype, {
    fnRowToPixels: function fnRowToPixels(a, b, c) {
    ...
    fnPixelsToRow: function fnPixelsToRow(a, b, c) {
    ...
    fnScrollToRow: function fnScrollToRow(a, b) {
      var c = this,
          d = !1,
    ...
    fnMeasure: function fnMeasure(a) {
    ...
    fnPageInfo: function fnPageInfo() {
    ...
    _fnScroll: function _fnScroll() {
      ...
      if (!this.s.skip && !this.s.ingnoreScroll) if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;else {
        ...
        if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
          ...
          if (d != this.s.dt._iDisplayStart && (this.s.tableTop = e(this.s.dt.nTable).offset().top, this.s.tableBottom = e(this.s.dt.nTable).height() + this.s.tableTop, b = function b() {
    ...
    _parseHeight: function _parseHeight(a) {
      var b,
    ...
    _fnDrawCallback: function _fnDrawCallback() {
      var a = this,
          b = this.s.heights,
          c = this.dom.scroller.scrollTop,
    ...
    _fnScrollForce: function _fnScrollForce() {
    ...
    _fnCalcRowHeight: function _fnCalcRowHeight() {
      var a = this.s.dt,
          b = a.nTable,
          c = b.cloneNode(!1),
