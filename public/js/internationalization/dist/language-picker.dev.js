...
var LanguageSelector = function LanguageSelector($element) {
...
LanguageSelector.prototype.changeLanguage = function () {
  ...
  this.chosenLanguage = LANGUAGES[this.$languageSelect.find(':selected').val()]; // set the language text for each list item
  ...
  this.$languagePageHdg.html(this.chosenLanguage.heading); // set the header background color
