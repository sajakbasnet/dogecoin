...
})(jQuery); // second demo of simple mde


var sample = ["### Instructions", "Enter text in the area on the left. For more info, click the ? (help) icon in the menu."];
var simplemde = new SimpleMDE({
  element: $("#smde")[0],
