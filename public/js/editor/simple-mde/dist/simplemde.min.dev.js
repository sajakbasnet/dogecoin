...
!function (e) {
  ...
  return function t(e, n, r) {
    ...
    3: [function (e, t, n) {
      (function (t) {
        ...
        a.prototype.slice = function (e, t) {
          ...
          var i,
              o = r - n;
          if (this === e && t > n && r > t) for (i = o - 1; i >= 0; i--) {
            e[i + t] = this[i + n];
          ...
          var o;
          if ("number" == typeof e) for (o = t; n > o; o++) {
            this[o] = e;
          } else {
    ...
    5: [function (t, n, r) {
      !function (i) {
        "object" == _typeof(r) && "object" == _typeof(n) ? i(t("../../lib/codemirror")) : "function" == typeof e && e.amd ? e(["../../lib/codemirror"], i) : i(CodeMirror);
      }(function (e) {
        "use strict";
    ...
    10: [function (t, n, r) {
      !function (t) {
        if ("object" == _typeof(r) && "object" == _typeof(n)) n.exports = t();else {
        ...
        function O(e) {
          for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
            ...
            if (!o.hidden) {
              ...
              if (2 > i && (i = yt(t)), (s > .001 || -.001 > s) && (ei(o.line, i), I(o.line), o.rest)) for (var c = 0; c < o.rest.length; c++) {
                I(o.rest[c]);
              }
            }
          }
        ...
        function se(e, t, n) {
          ...
          for (l || 1 != t.childNodes.length || 3 != t.firstChild.nodeType || (l = t.firstChild, n && (n = l.nodeValue.length)); s.parentNode != i;) {
            s = s.parentNode;
          }
        ...
        function Qt(e) {
          ...
          if (nn(t), !Ti(t, e) && !Gt(t.display, e)) {
            ...
            if (n && !t.isReadOnly()) if (r && r.length && window.FileReader && window.File) for (var i = r.length, o = Array(i), a = 0, l = function l(e, r) {
              ...
              try {
                ...
                if (o) {
                  ...
                  if (Me(t.doc, de(n, n)), c) for (var s = 0; s < c.length; ++s) {
        ...
        function Fn(e, t, n, r) {
          ...
          var f = "",
              h = 0;
          if (e.options.indentWithTabs) for (var d = Math.floor(c / a); d; --d) {
            h += a, f += "	";
          }
        ...
        function or(e, t) {
          ...
          if (!c) {
            var m,
                g = t.text.length - 2;
            if (g > 0 && l) for (var f = 0; f < l.length; ++f) {
        ...
        function pr(e, t) {
          var n,
              r = Wo && e.markedSpans;
          if (r) for (var i, o = 0; o < r.length; ++o) {
        ...
        function kr(e, t) {
          ...
          if (n) for (var r, i = 0; i < n.length; ++i) {
        ...
        function ho(e, t, n, r) {
          var i = t + n;
          if (r) for (; i > 0 && zi(e.text.charAt(i));) {
            i += n;
          }
        ...
        e.prototype = {
          ...
          cursorCoords: function cursorCoords(e, t) {
            ...
            return n = null == e ? r.head : "object" == _typeof(e) ? me(this.doc, e) : e ? r.from() : r.to(), dt(this, n, t || "page");
          },
    ...
    11: [function (t, n, r) {
      !function (i) {
        "object" == _typeof(r) && "object" == _typeof(n) ? i(t("../../lib/codemirror"), t("../markdown/markdown"), t("../../addon/mode/overlay")) : "function" == typeof e && e.amd ? e(["../../lib/codemirror", "../markdown/markdown", "../../addon/mode/overlay"], i) : i(CodeMirror);
      }(function (e) {
        "use strict";
    ...
    12: [function (t, n, r) {
      !function (i) {
        "object" == _typeof(r) && "object" == _typeof(n) ? i(t("../../lib/codemirror"), t("../xml/xml"), t("../meta")) : "function" == typeof e && e.amd ? e(["../../lib/codemirror", "../xml/xml", "../meta"], i) : i(CodeMirror);
      }(function (e) {
        "use strict";
        ...
        e.defineMode("markdown", function (t, n) {
          ...
          function s(t, o) {
            ...
            if ((a(o.prevLine) || s) && (t.match(T, !1) || t.match(M, !1))) {
              ...
              for (t.match(T, !0) ? d = "ul" : (t.match(M, !0), d = "ol"), o.indentation = t.column() + t.current().length, o.list = !0; o.listStack && t.column() < o.listStack[o.listStack.length - 1];) {
                o.listStack.pop();
              }
      ...
      (function (t) {
        (function () {
            ...
            for (var r, i, o, a, l, s, c, u, f, e = e.replace(/^ +$/gm, ""); e;) {
              if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({
                ...
                for (e = e.substring(o[0].length), a = o[2], this.tokens.push({
                  type: "list_start",
                  ordered: a.length > 1
                }), o = o[0].match(this.rules.item), r = !1, f = o.length, u = 0; f > u; u++) {
          ...
          p._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, p._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, p.link = c(p.link)("inside", p._inside)("href", p._href)(), p.reflink = c(p.reflink)("inside", p._inside)(), p.normal = f({}, p), p.pedantic = f({}, p.normal, {
            ...
            renderer: new o(),
            xhtml: !1
          }, h.Parser = a, h.parser = a.parse, h.Renderer = o, h.Lexer = t, h.lexer = t.lex, h.InlineLexer = i, h.inlineLexer = i.output, h.parse = h, "undefined" != typeof n && "object" == _typeof(r) ? n.exports = h : "function" == typeof e && e.amd ? e(function () {
            return h;
          }) : this.marked = h;
        }).call(function () {
        ...
        var i = function i(e, t, n, _i2) {
          if (_i2 = _i2 || {}, this.dictionary = null, this.rules = {}, this.dictionaryTable = {}, this.compoundRules = [], this.compoundRuleCodes = {}, this.replacementTable = [], this.flags = _i2.flags || {}, e) {
            if (this.dictionary = e, "undefined" != typeof window && "chrome" in window && "extension" in window.chrome && "getURL" in window.chrome.extension) t || (t = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".aff"))), n || (n = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + e + "/" + e + ".dic")));else {
              if (_i2.dictionaryPath) var o = _i2.dictionaryPath;else if ("undefined" != typeof r) var o = r + "/dictionaries";else var o = "./dictionaries";
            ...
            function n(e) {
              for (var t = [], n = 0, r = e.length; r > n; n++) {
                ...
                for (var h = [], a = 0, l = o.length; l > a; a++) {
                  var u = o[a];
                  if (u[1]) for (var d = 0, p = c.alphabet.length; p > d; d++) {
    ...
    20: [function (e, t, n) {
      ...
      function R(e) {
        if (!/editor-preview-active/.test(e.getWrapperElement().lastChild.className)) for (var t, n = e.getCursor("start"), r = e.getCursor("end"), i = n.line; i <= r.line; i++) {
          t = e.getLine(i), t = t.replace(/^[ ]*([# ]+|\*|\-|[> ]+|[0-9]+(.|\)))[ ]*/, ""), e.replaceRange(t, {
            line: i,
            ch: 0
          }, {
            line: i,
      ...
      function B(e) {
        e = e || {}, e.parent = this;
        var t = !0;
        if (e.autoDownloadFontAwesome === !1 && (t = !1), e.autoDownloadFontAwesome !== !0) for (var n = document.styleSheets, r = 0; r < n.length; r++) {
