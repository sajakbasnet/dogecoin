...
define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var g = function g(e) {
    ...
    p.call(this), this.HighlightRules = s, this.createModeDelegates({
      "js-": d,
      "css-": v,
      "php-": m
    });
  ...
  r.inherits(g, p), function () {
    this.tokenRe = new RegExp("^[" + h.packages.L + h.packages.Mn + h.packages.Mc + h.packages.Nd + h.packages.Pc + "_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + h.packages.L + h.packages.Mn + h.packages.Mc + h.packages.Nd + h.packages.Pc + "_]|s])+", "g"), this.lineCommentStart = ["//", "#"], this.blockComment = {
      start: "/*",
      end: "*/"
    }, this.createWorker = function (e) {
