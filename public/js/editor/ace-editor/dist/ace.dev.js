...
(function () {
  ...
  var t = function t(e, n, r) {
    ...
    if (!s) {
      ...
      if (typeof s == "function") {
        ...
        o = f || u.exports, t.modules[_i] = o, delete t.payloads[_i];
      }
  ...
  var r = e("../lib/event"),
    ...
    function b(e) {
      if (h) return;
      if (k) t = 0, r = e ? 0 : n.value.length - 1;else var t = e ? 2 : 1,
          r = 2;
    ...
    this.normalizeRules = function () {
      function i(s) {
        ...
        for (var u = 0; u < o.length; u++) {
          ...
          if (a.rules) for (var c in a.rules) {
  ...
  (function () {
    ...
    r.implement(this, o), this.setDocument = function (e) {
      ...
      try {
        ...
        (typeof console === "undefined" ? "undefined" : _typeof(console)) == "object" && (console.log("Could not load worker"), console.log(e)), this.$worker = null;
      }
  ...
  (function () {
    r.implement(this, u), this.EOF_CHAR = "\xB6", this.EOL_CHAR_LF = "\xAC", this.EOL_CHAR_CRLF = "\xA4", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "\u2192", this.SPACE_CHAR = "\xB7", this.$padding = 0, this.$updateEolChar = function () {
      ...
      for (var n = 1; n < e + 1; n++) {
        this.showInvisibles ? t.push("<span class='ace_invisible ace_invisible_tab'>" + this.TAB_CHAR + s.stringRepeat("\xA0", n - 1) + "</span>") : t.push(s.stringRepeat("\xA0", n));
      }
      ...
      if (this.displayIndentGuides) {
        ...
        } else var u = s.stringRepeat("\xA0", this.tabSize),
            a = u;
      ...
      var i = this,
        ...
        if (n) return i.showInvisibles ? "<span class='ace_invisible ace_invisible_space'>" + s.stringRepeat(i.SPACE_CHAR, e.length) + "</span>" : s.stringRepeat("\xA0", e.length);
        if (e == "&") return "&#38;";
        if (e == "<") return "&#60;";
