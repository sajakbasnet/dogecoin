...
(function (e) {
  ...
  (function () {
    ...
    Combinator.prototype = new SyntaxUnit(), Combinator.prototype.constructor = Combinator, MediaFeature.prototype = new SyntaxUnit(), MediaFeature.prototype.constructor = MediaFeature, MediaQuery.prototype = new SyntaxUnit(), MediaQuery.prototype.constructor = MediaQuery, Parser.DEFAULT_TYPE = 0, Parser.COMBINATOR_TYPE = 1, Parser.MEDIA_FEATURE_TYPE = 2, Parser.MEDIA_QUERY_TYPE = 3, Parser.PROPERTY_NAME_TYPE = 4, Parser.PROPERTY_VALUE_TYPE = 5, Parser.PROPERTY_VALUE_PART_TYPE = 6, Parser.SELECTOR_TYPE = 7, Parser.SELECTOR_PART_TYPE = 8, Parser.SELECTOR_SUB_PART_TYPE = 9, Parser.prototype = function () {
      var e = new EventTarget(),
        ...
        _media: function _media() {
          ...
          for (;;) {
            if (e.peek() == Tokens.PAGE_SYM) this._page();else if (e.peek() == Tokens.FONT_FACE_SYM) this._font_face();else if (e.peek() == Tokens.VIEWPORT_SYM) this._viewport();else if (!this._ruleset()) break;
          }
        ...
        _simple_selector_sequence: function _simple_selector_sequence() {
          var e = this._tokenStream,
            ...
            return e.match(Tokens.HASH) ? new SelectorSubPart(e.token().value, "id", e.token().startLine, e.token().startCol) : null;
              ...
              f,
              l;
          f = e.LT(1).startLine, l = e.LT(1).startCol, t = this._type_selector(), t || (t = this._viho()), t !== null && (r += t);
        ...
        _negation_arg: function _negation_arg() {
          var e = this._tokenStream,
              t = [this._type_selector, this._viho, function () {
            return e.match(Tokens.HASH) ? new SelectorSubPart(e.token().value, "id", e.token().startLine, e.token().startCol) : null;
    ...
    var ValidationTypes = {
      ...
      simple: {
        ...
        "<content-sizing>": function contentSizing(e) {
        ...
        "<flex-grow>": function flexGrow(e) {
          return this["<number>"](e);
        },
        "<flex-shrink>": function flexShrink(e) {
          return this["<number>"](e);
        },
        "<width>": function width(e) {
          return this["<margin-width>"](e);
        },
        "<flex-basis>": function flexBasis(e) {
          return this["<width>"](e);
        },
        "<flex-direction>": function flexDirection(e) {
          return ValidationTypes.isLiteral(e, "row | row-reverse | column | column-reverse");
        },
        "<flex-wrap>": function flexWrap(e) {
  ...
  var util = {
    isArray: function isArray(e) {
      return Array.isArray(e) || _typeof(e) == "object" && objectToString(e) === "[object Array]";
    },
    isDate: function isDate(e) {
      return _typeof(e) == "object" && objectToString(e) === "[object Date]";
    },
    isRegExp: function isRegExp(e) {
      return _typeof(e) == "object" && objectToString(e) === "[object RegExp]";
    },
    getRegExpFlags: function getRegExpFlags(e) {
      var t = "";
      return e.global && (t += "g"), e.ignoreCase && (t += "i"), e.multiline && (t += "m"), t;
    }
  };
  _typeof(module) == "object" && (module.exports = clone), clone.clonePrototype = function (e) {
    if (e === null) return null;
  ...
  var CSSLint = function () {
    ...
    return r.version = "@VERSION@", r.addRule = function (t) {
      ...
      for (s in r) {
        r.hasOwnProperty(s) && r[s] && e[s] && e[s].init(f, o);
      }
  ...
  Reporter.prototype = {
      ...
      e.addListener("startrule", function () {
        ...
        for (a in e) {
          if (e.hasOwnProperty(a)) {
            ...
            if (c.length > h.length) for (s = 0, o = c.length; s < o; s++) {
    ...
    init: function init(e, t) {
      ...
      e.addListener("startrule", o), e.addListener("startfontface", o), e.addListener("startpage", o), e.addListener("startpagemargin", o), e.addListener("startkeyframerule", o), e.addListener("property", function (e) {
        var s = e.property,
            ...
            l = u.length;
        if (i[o]) while (a < l) {
          u[a].type === "color" && ("alpha" in u[a] || "hue" in u[a] ? (/([^\)]+)\(/.test(u[a]) && (f = RegExp.$1.toUpperCase()), (!r || r.property.text.toLowerCase() !== o || r.colorType !== "compat") && t.report("Fallback " + o + " (hex or RGB) should precede " + f + " " + o + ".", e.line, e.col, n)) : e.colorType = "compat"), a++;
        }
        r = e;
      });
    }
    ...
    init: function init(e, t) {
      ...
      e.addListener("startrule", function (r) {
        ...
        for (a = 0; a < i.length; a++) {
          s = i[a], o = s.parts[s.parts.length - 1];
          if (o.type === e.SELECTOR_PART_TYPE) for (f = 0; f < o.modifiers.length; f++) {
