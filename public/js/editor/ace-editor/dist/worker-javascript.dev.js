...
})(void 0), define("ace/lib/oop", ["require", "exports", "module"], function (e, t, n) {
  "use strict";
  ...
  n.exports = function r(t, n, i) {
    ...
    2: [function (e, t, n) {
      (function () {
        ...
        N.bind = function (e, t) {
          ...
          return n = f.call(arguments, 2), _r = function r() {
        ...
        N.template = function (e, t, n) {
          ...
          var i = new RegExp([(n.escape || j).source, (n.interpolate || j).source, (n.evaluate || j).source].join("|") + "|$", "g"),
              s = 0,
              o = "__p+='";
    ...
    3: [function (e, t, n) {
      var r = e("underscore"),
        ...
        function ct(e, t) {
          var n = f.syntax[e];
          if (!n || _typeof(n) != "object") f.syntax[e] = n = {
            id: e,
            lbp: t,
            value: e
          };
        ...
        function Ct(e) {
          ...
          function r(e) {
            while (!e.identifier && _typeof(e.left) == "object") {
              e = e.left;
            }
        ...
        function Ht() {
          ...
          s.identifier && !o && nt().id === ":" && (rt(), rt(":"), D = Object.create(i), et(s.value, {
            type: "label"
          }), !f.tokens.next.labelled && f.tokens.next.value !== "{" && K("W028", f.tokens.next, s.value, f.tokens.next.value), f.tokens.next.label = s.value, s = f.tokens.next);
        ...
        function Bt(e) {
          ...
          while (!f.tokens.next.reach && f.tokens.next.id !== "(end)") {
            f.tokens.next.id === ";" ? (n = nt(), (!n || n.id !== "(" && n.id !== "[") && K("W032"), rt(";")) : t.push(Ht(e === f.tokens.next.line));
          }
        ...
        function Wt(e) {
          ...
          if (e) {
            if (Array.isArray(e)) {
              for (var l in e) {
                ...
                t.value !== "," && (i.push(t.value), et(t.value, {
                  type: "unused",
                  token: t
                }));
              }
            ...
            if (e.identifier === !0) return et(e.value, {
              type: "unused",
              token: e
            }), [e];
          }
          ...
          for (;;) {
            if (r.contains(["{", "["], f.tokens.next.id)) {
              ...
              for (u in o) {
                u = o[u], u.id && (i.push(u.id), et(u.id, {
                  type: "unused",
                  token: u.token
                }));
              }
        ...
        function Jt(t, n, i, s) {
          ...
          return f.option = Object.create(f.option), f.ignored = Object.create(f.ignored), D = Object.create(D), w = $t(t || '"' + e + '"', f.tokens.next, D, {
            ...
            "(context)": w,
            "(generator)": i ? !0 : null
          }), o = w, f.tokens.curr.funct = w, E.push(w), t && et(t, {
            type: "function"
          }), w["(params)"] = Wt(s), w["(metrics)"].verifyMaxParametersPerFunction(w["(params)"]), c.undefs = r.filter(c.undefs, function (e) {
        ...
        function Kt(e) {
          return {
            ...
            verifyMaxParametersPerFunction: function verifyMaxParametersPerFunction(t) {
        ...
        function Yt() {
          ...
          var i = function i() {
            ...
            } else f.tokens.next.value === "," ? n.push({
              id: null,
              token: f.tokens.curr
            }) : f.tokens.next.value === "(" ? (rt("("), i(), rt(")")) : (e = _t(), e && n.push({
              id: e,
              token: f.tokens.curr
            }));
          };
          ...
          if (f.tokens.next.value === "[") {
            ...
            rt("{"), e = _t(), f.tokens.next.value === ":" ? (rt(":"), i()) : n.push({
              id: e,
              token: f.tokens.curr
            });
        ...
        var e,
          ...
          trailing: !0
            ...
            g,
            y,
            b = ["closure", "exception", "global", "label", "outer", "unused", "var"],
            w,
            E,
            S,
            x,
        ...
        gt("(number)", function () {
          ...
          nud: function nud() {
            var t = this.value,
                ...
                r,
                i;
            typeof n == "function" ? n = undefined : !w["(blockscope)"].current.has(t) && typeof n == "boolean" && (r = w, w = E[0], et(t, {
              type: "var"
            }), n = w, w = r), i = w["(blockscope)"].getlabel(t);
            if (w === n || i) switch (i ? i[t]["(type)"] : w[t]) {
              ...
              default:
                if (n === !0) w[t] = !0;else if (n === null) K("W039", f.tokens.curr, t), qt(f.tokens.curr);else if (_typeof(n) != "object") (e !== "typeof" && e !== "delete" || f.tokens.next && (f.tokens.next.value === "." || f.tokens.next.value === "[")) && $(w, "W117", f.tokens.curr, t), w[t] = !0, qt(f.tokens.curr);else switch (n[t]) {
                  case "function":
                  case "unction":
        ...
        Et("||", function (e, t) {
          ...
          do {
            n = nt(s), n.value === "(" ? u += 1 : n.value === ")" && (u -= 1), s += 1, i = nt(s);
          ...
          e.nud = function (e) {
            ...
            for (;;) {
              ...
              lt({
                allowTrailing: !0,
                property: !0
              }), f.tokens.next.id === "," ? K("W070", f.tokens.curr) : f.tokens.next.id === "}" && !f.option.inES5(!0) && K("W070", f.tokens.curr);
            }

            t && (N -= f.option.indent), rt("}", this);
            if (f.option.inES5()) for (var d in a) {
              r.has(a, d) && a[d].setter && !a[d].getter && K("W078", a[d].setterToken);
            }
            return this;
          }, e.fud = function () {
        ...
        var en = pt("const", function (e) {
          ...
          for (;;) {
            ...
            for (var o in t) {
              t.hasOwnProperty(o) && (o = t[o], w[o.id] === "const" && K("E011", null, o.id), w["(global)"] && M[o.id] === !1 && K("W079", o.token, o.id), o.id && (et(o.id, {
                token: o.token,
                type: "const",
                unused: !0
              }), s.push(o.token)));
        ...
        var tn = pt("var", function (e) {
          ...
          for (;;) {
            ...
            for (var o in t) {
              t.hasOwnProperty(o) && (o = t[o], f.option.inESNext() && w[o.id] === "const" && K("E011", null, o.id), w["(global)"] && M[o.id] === !1 && K("W079", o.token, o.id), o.id && (et(o.id, {
                type: "unused",
                token: o.token
              }), s.push(o.token)));
            }
        ...
        var nn = pt("let", function (e) {
          ...
          for (;;) {
            ...
            for (var u in t) {
              t.hasOwnProperty(u) && (u = t[u], f.option.inESNext() && w[u.id] === "const" && K("E011", null, u.id), w["(global)"] && M[u.id] === !1 && K("W079", u.token, u.id), u.id && !w["(nolet)"] && (et(u.id, {
                type: "unused",
                token: u.token,
                islet: !0
              }), o.push(u.token)));
        ...
        nn.exps = !0, dt("class", function () {
          ...
          return w[t] === "const" && K("E011", null, t), et(t, {
            type: "unction",
            token: f.tokens.curr
          }), Jt(t, {
            statement: !0
          }, e), f.tokens.next.id === "(" && f.tokens.next.line === f.tokens.curr.line && G("E039"), this;
          ...
          function t() {
            ...
            rt("catch"), rt("("), D = Object.create(e), t = f.tokens.next.value, f.tokens.next.type !== "(identifier)" && (t = null, K("E030", f.tokens.next, t)), rt(), w = $t("(catch)", f.tokens.next, D, {
              ...
              type: "exception"
            }), f.tokens.next.value === "if" && (f.option.inMoz(!0) || K("W118", f.tokens.curr, "catch filter"), rt("if"), ot(0)), rt(")"), f.tokens.curr.funct = w, E.push(w), Ft(!1), D = e, w["(last)"] = f.tokens.curr.line, w["(lastcharacter)"] = f.tokens.curr.character, w = w["(context)"];
          }
          ...
          while (f.tokens.next.id === "catch") {
            Qt(), e && !f.option.inMoz(!0) && K("W118", f.tokens.next, "multiple catch blocks"), t(), e = !0;
          }
          ...
          if (r.contains(u, s.value)) {
            ...
            rt(s.value), ot(20), rt(")", t), e = Ft(!0, !0), f.option.forin && e && (e.length > 1 || _typeof(e[0]) != "object" || e[0].value !== "if") && K("W089", this), w["(breakage)"] -= 1, w["(loopage)"] -= 1;
          } else {
            i && G("E045", i);
          ...
          if (f.tokens.next.identifier) this.name = _t(), et(this.name, {
            type: "unused",
            token: f.tokens.curr
          });else {
            rt("{");
            ...
            for (;;) {
              ...
              var e;
              f.tokens.next.type === "default" ? (e = "default", rt("default")) : e = _t(), f.tokens.next.value === "as" && (rt("as"), e = _t()), et(e, {
                type: "unused",
                token: f.tokens.curr
              });
          ...
          es5: !0
        }), bt("final"), bt("float"), bt("goto"), bt("implements", {
          es5: !0,
          strictOnly: !0
        }), bt("import", {
          es5: !0
          ...
          es5: !0
        }), bt("synchronized"), bt("transient"), bt("volatile");
        ...
        var on = function on() {
          ...
          return {
            ...
            getlabel: function getlabel(e) {
              for (var n = t.length - 1; n >= 0; --n) {
                if (r.has(t[n], e) && !t[n][e]["(shadowed)"]) return t[n];
              }
            },
            ...
            cn = function cn(e, n, i) {
          function v(e, t) {
            if (!e) return;
            !Array.isArray(e) && _typeof(e) == "object" && (e = Object.keys(e)), e.forEach(t);
          }
          ...
          if (n) {
            ...
            for (l = 0; l < h.length; l++) {
              /^-W\d{3}$/g.test(h[l]) ? d[h[l].slice(1)] = !0 : (p[h[l]] = n[h[l]], h[l] === "newcap" && n[h[l]] === !1 && (p["(explicitNewcap)"] = !0));
            }
          }
          ...
          try {
            ...
            var b = function b(e, t) {
              ...
              r && o[r] && o[r].indexOf(n) !== -1 && Q("W098", i, s, e), H.push({
                name: e,
                line: i,
                character: s
              });
            ...
            for (o = 0; o < c.undefs.length; o += 1) {
              a = c.undefs[o].slice(0), b(a[2].value, a[0]) ? O(a[2].value, a[2].line) : f.option.undef && K.apply(K, a.slice(1));
            }
            ...
            for (var z in g) {
              r.has(g, z) && !r.has(S, z) && !r.has(y, z) && R(z, g[z], "var");
            }
          } catch ($) {
          ...
          if (c.scope === "(main)") {
            ...
            for (o = 0; o < c.internals.length; o += 1) {
              a = c.internals[o], n.scope = a.elem, cn(a.value, n, i);
            }
          }
    ...
    4: [function (e, t, n) {
      ...
      h.prototype = {
        ...
        triggerAsync: function triggerAsync(e, t, n, r) {
          n.push(function () {
            r() && this.trigger(e, t);
          }.bind(this));
        },
        ...
        scanComments: function scanComments() {
          ...
          if (t === "*") {
            ...
            return this.skip(2), this.inComment = !1, s("/*", o, {
              isMultiline: !0
            });
          }
        },
        ...
        scanStringLiteral: function scanStringLiteral(e) {
          var t = this.peek();
          if (t !== '"' && t !== "'") return null;
