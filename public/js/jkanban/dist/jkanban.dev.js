  ...
  1: [function (require, module, exports) {
    ...
    (function () {
      this.jKanban = function () {
        ...
        this.init = function () {
          //set initial boards
          __setBoard(); //set drag with dragula
        ...
        this.addElement = function (boardID, element) {
          ...
          nodeItem.innerHTML = __buildItemTitle(element.title); //add function
        ...
        this.addBoards = function (boards, isInit) {
          ...
          var buttonContent = self.options.buttonContent; //for on all the boards
          ...
          for (var boardkey in boards) {
            ...
            boardNode.classList.add("kanban-board"); //set style
            ...
            boardNode.style.marginRight = self.options.gutter; // header board
            ...
            headerBoard.innerHTML = '<div class="kanban-title-board">' + board.title + "</div>"; // if add button is true, add button to the board

            if (addButton) {
              var btn = document.createElement("BUTTON");
              var t = document.createTextNode(buttonContent);
              btn.setAttribute("class", "kanban-title-button btn btn-default btn-xs");
              btn.appendChild(t); //var buttonHtml = '<button class="kanban-title-button btn btn-default btn-xs">'+buttonContent+'</button>'
            ...
            for (var itemkey in board.item) {
              ...
              nodeItem.innerHTML = __buildItemTitle(itemKanban.title); //add function
              ...
              __appendCustomProperties(nodeItem, itemKanban); //add click handler of item
            ...
            var footerBoard = document.createElement("footer"); //board assembly

            boardNode.appendChild(headerBoard);
            boardNode.appendChild(contentBoard);
            boardNode.appendChild(footerBoard); //board add
        ...
        this.replaceElement = function (el, element) {
          ...
          nodeItem.innerHTML = element.title; // add function
        ...
        this.onButtonClick = function (el) {}; //PRIVATE FUNCTION
        ...
        function __setBoard() {
          self.element = document.querySelector(self.options.element); //create container

          var boardContainer = document.createElement("div");
          boardContainer.classList.add("kanban-container");
          self.container = boardContainer; //add boards

          self.addBoards(self.options.boards, true); //appends to container
        ...
        function __onButtonClickHandler(nodeItem, boardId) {
          nodeItem.addEventListener("click", function (e) {
            e.preventDefault();
            self.options.buttonClick(this, boardId); // if(typeof(this.clickfn) === 'function')
            //     this.clickfn(this);
          });
        }
