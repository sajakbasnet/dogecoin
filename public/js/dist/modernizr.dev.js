...
!function (e, n, t) {
    ...
    for (var f in C) {
      if (C.hasOwnProperty(f)) {
        ...
        for (i = r(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) {
          s = e[o], a = s.split("."), 1 === a.length ? Modernizr[a[0]] = i : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = i), _.push((i ? "" : "no-") + a.join("-"));
        }
      }
    }
  }
  ...
  function l(e, t, r, i) {
    ...
    if (parseInt(r, 10)) for (; r--;) {
      f = s("div"), f.id = i ? i[r] : d + (r + 1), p.appendChild(f);
    }
    return o = s("style"), o.type = "text/css", o.id = "s" + d, (c.fake ? c : p).appendChild(o), c.appendChild(p), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(n.createTextNode(e)), p.id = d, c.fake && (c.style.background = "", c.style.overflow = "hidden", l = x.style.overflow, x.style.overflow = "hidden", x.appendChild(c)), a = t(p, e), c.fake ? (c.parentNode.removeChild(c), x.style.overflow = l, x.offsetHeight) : p.parentNode.removeChild(p), !!a;
  }
  ...
  function c(e, n, t) {
    ...
    for (var o in e) {
      if (e[o] in n) return t === !1 ? e[o] : (i = n[e[o]], r(i, "function") ? p(i, t || n) : i);
    }
  ...
  function h(n, r) {
    ...
    if ("CSS" in e && "supports" in e.CSS) {
      for (; i--;) {
        if (e.CSS.supports(m(n[i]), r)) return !0;
      }
  ...
  function g(e, n, t, i, o) {
    ...
    return r(n, "string") || r(n, "undefined") ? v(a, n, i, o) : (a = (e + " " + k.join(s + " ") + s).split(" "), c(a, n, t));
  }
  ...
  Modernizr.prototype = w, Modernizr = new Modernizr(), Modernizr.addTest("ie8compat", !e.addEventListener && !!n.documentMode && 7 === n.documentMode), Modernizr.addTest("json", "JSON" in e && "parse" in JSON && "stringify" in JSON);
  ...
  var x = n.documentElement,
    ...
    function e(e, n) {
      var i;
      return e ? (n && "string" != typeof n || (n = s(n || "div")), e = "on" + e, i = e in n, !i && r && (n.setAttribute || (n = s("div")), n.setAttribute(e, ""), i = "function" == typeof n[e], n[e] !== t && (n[e] = t), n.removeAttribute(e)), i) : !1;
    }
  ...
  !function () {
    ...
    N = r(e, "undefined") || r(e.call, "undefined") ? function (e, n) {
  ...
  Modernizr.addTest("requestanimationframe", !!M("requestAnimationFrame", e), {
    aliases: ["raf"]
  }), w.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("cssfilters", function () {
    if (Modernizr.supports) return y("filter", "blur(2px)");
    var e = s("a");
    return e.style.cssText = T.join("filter:blur(2px); "), !!e.style.length && (n.documentMode === t || n.documentMode > 9);
    ...
    return e;
  }), Modernizr.addTest("csstransitions", y("transition", "all", !0)), i(), o(_), delete w.addTest, delete w.addAsyncTest;
