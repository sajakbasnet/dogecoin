...
(function (W) {
  ...
  if (typeof define === "undefined") {
    ...
    typeof _require !== "undefined" && !D(_require) && (n = _require, _require = void 0);

    g = requirejs = function requirejs(b, c, d, p) {
      var i,
          j = "_";
    ...
    s = g.s = {
      contexts: w,
      newContext: function newContext(b) {
        function c(a, f, x) {
          var e,
              m,
              b,
          ...
          if (a && a.charAt(0) === ".") if (f) {
            ...
            for (e = 0; f[e]; e += 1) {
              if (m = f[e], m === ".") f.splice(e, 1), e -= 1;else if (m === "..") if (e === 1 && (f[2] === ".." || f[0] === "..")) break;else e > 0 && (f.splice(e - 1, 2), e -= 2);
            }
          ...
          if (x && (g || l) && j) {
            ...
            for (e = f.length; e > 0; e -= 1) {
              b = f.slice(0, e).join("/");
              if (g) for (m = g.length; m > 0; m -= 1) {
                if (x = j[g.slice(0, m).join("/")]) if (x = x[b]) {
                  c = x;
                  d = e;
                  break;
                }
        ...
        function w() {
          var a,
              ...
              b,
              e,
              m = (b = k.waitSeconds * 1E3) && h.startTime + b < new Date().getTime(),
              c = [],
              g = [],
              i = !1,
              j = !0;
          ...
          if (!S) {
            ...
            if (m && c.length) return b = G("timeout", "Load timeout for modules: " + c, null, c), b.contextName = h.contextName, z(b);
            j && t(g, function (a) {
              u(a, {}, {});
            });
        ...
        function I() {
          ...
          for (s(); C.length;) {
            if (a = C.shift(), a[0] === null) return z(G("mismatch", "Mismatched anonymous define() module: " + a[a.length - 1]));else y(a);
          }
        }
                  ...
                  if (!this.defining) {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                      if (D(m)) {
                        ...
                        if (a) return a.requireMap = this.map, a.requireModules = [this.map.id], a.requireType = "define", z(this.error = a);
                      } else e = m;
        ...
        h = {
          ...
          configure: function configure(a) {
            ...
            A(a, function (a, b) {
              e[b] ? b === "map" ? O(k[b], a, !0, !0) : O(k[b], a, !0) : k[b] = a;
            });
            ...
            if (a.packages) t(a.packages, function (a) {
              ...
              b[a.name] = {
                ...
                main: (a.main || "main").replace(ea, "").replace($, "")
              };
            }), k.pkgs = b;
            A(l, function (a, b) {
          ...
          makeRequire: function makeRequire(a, f) {
            ...
            if (!a) d.undef = function (b) {
              ...
              if (d) {
                if (d.events.defined) V[b] = d.events;
                delete l[b];
              }
            };
            return d;
          ...
          completeLoad: function completeLoad(a) {
            ...
            c = l[a];
            if (!b && !o[a] && c && !c.inited) if (k.enforceDefine && (!g || !X(g))) {
              if (p(a)) return;else return z(G("nodefine", "No define call for " + a, null, [a]));
            } else y([a, d.deps || [], d.exportsFn]);
            w();
          },
          nameToUrl: function nameToUrl(a, b) {
            var c, d, i, h, j, l;
          ...
          onScriptLoad: function onScriptLoad(a) {
            if (a.type === "load" || ga.test((a.currentTarget || a.srcElement).readyState)) H = null, a = B(a), h.completeLoad(a.id);
          },
