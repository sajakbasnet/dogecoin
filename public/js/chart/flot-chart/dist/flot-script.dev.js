...
if ($("#flot-categories").length > 0) {
  var a = {
    ...
    data: [["Jan", 25], ["Feb", 8], ["Mar", 4], ["Apr", 13], ["May", 17], ["Jun", 9], ["Jul", 5], ["Aug", 11], ["Sep", 17], ["Oct", 8], ["Nov", 26]]
  };
...
$(function () {
  ...
  var data1 = [[1, 1, .5, .1, .3], [2, 2, .3, .5, .2], [3, 3, .9, .5, .2], [1.5, -.05, .5, .1, .3], [3.15, 1., .5, .1, .3], [2.5, -1., .5, .1, .3]];
  var data1_points = {
    show: true,
    radius: 5,
    errorbars: "xy",
...
if ($("#multiple-real-timeupdate ").length > 0) {
  ...
  g && !isNaN(+g) && (f = +g, f < 1 ? f = 1 : f > 2e3 && (f = 2e3), $(void 0).val("" + f));
