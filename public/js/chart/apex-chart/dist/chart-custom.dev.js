...
chart.render(); // area spaline chart
...
chart.render(); // candlestick chart
...
chart5.render(); // annotation chart
...
var chart6 = new ApexCharts(document.querySelector("#annotationchart"), options6);
chart6.render(); // mixed chart
...
chart9.render(); // radar chart

var options10 = _defineProperty({
  chart: {
    height: 350,
    type: 'radar',
    toolbar: {
