...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: 'My First Dataset',
      data: [11, 16, 7, 3, 14],
      backgroundColor: [zetaAdminConfig.primary, zetaAdminConfig.secondary, zetaAdminConfig.success, zetaAdminConfig.light_1, zetaAdminConfig.warning]
    }]
  },
  options: {
    responsive: true,
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: [zetaAdminConfig.primary, zetaAdminConfig.danger, zetaAdminConfig.success, zetaAdminConfig.warning, zetaAdminConfig.secondary]
    }]
  },
  options: {
    responsive: true,
...
var mixedChart = new Chart(ctx, {
  ...
  data: {
    datasets: [{
      ...
      backgroundColor: [zetaAdminConfig.primary, zetaAdminConfig.secondary, zetaAdminConfig.info, zetaAdminConfig.success, zetaAdminConfig.warning, zetaAdminConfig.danger]
    }, {
      type: 'line',
