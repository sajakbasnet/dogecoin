  ...
  return function (a, b) {
    ...
    b.namespaces = {
      ...
      for (a = a || {}, c = 1; c < arguments.length; c++) {
        ...
        for (var f in d) {
          e = d[f], "object" != _typeof(e) || null === e || e instanceof Array ? a[f] = e : a[f] = b.extend(a[f], e);
        }
      }
      ...
      for (var f = [], g = !0, h = 0; h < a.length; h += 2) {
        void 0 === b.getMultiValue(c[h / 2].value) ? d.fillHoles || (g = !0) : (d.increasingX && h >= 2 && a[h] <= a[h - 2] && (g = !0), g && (f.push({
          pathCoordinates: [],
          valueData: []
