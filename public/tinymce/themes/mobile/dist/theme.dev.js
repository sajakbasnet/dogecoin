...
(function () {
  ...
  var find$2 = function find$2(obj, pred) {
    var props = keys(obj);
  ...
  var clear = function clear(component, swapConfig, _swapState) {
  ...
  var ancestor = function ancestor(scope, transform, isRoot) {
  ...
  var closest = function closest(scope, transform, isRoot) {
  ...
  var get$5 = function get$5(element, property) {
    var dom = element.dom;
  ...
  var getKeydownRules = function getKeydownRules(component, _simulatedEvent, executeConfig, _executeState) {
  ...
  var getKeyupRules = function getKeyupRules(component, _simulatedEvent, executeConfig, _executeState) {
  ...
  var flatgrid = function flatgrid() {
  ...
  var focusIn = function focusIn(component, gridConfig, _gridState) {
  ...
  var execute$2 = function execute$2(component, simulatedEvent, gridConfig, _gridState) {
  ...
  var doEscape = function doEscape(component, simulatedEvent, gridConfig) {
  ...
  var schema$3 = [strict$1('selector'), defaulted$1('getInitial', Optional.none), defaulted$1('execute', defaultExecute), onKeyboardHandler('onEscape'), defaulted$1('executeOnMove', false), defaulted$1('allowVertical', true)];
  ...
  var focusIn$1 = function focusIn$1(component, flowConfig, _state) {
  ...
  var doEscape$1 = function doEscape$1(component, simulatedEvent, flowConfig) {
  ...
  var schema$4 = [strictObjOf('selectors', [strict$1('row'), strict$1('cell')]), defaulted$1('cycles', true), defaulted$1('previousSelector', Optional.none), defaulted$1('execute', defaultExecute)];

  var focusIn$2 = function focusIn$2(component, matrixConfig, _state) {
  ...
  var focusIn$3 = function focusIn$3(component, menuConfig, _state) {
  ...
  var exhibit$2 = function exhibit$2() {
    return nu$5({
      styles: {
  ...
  var events$4 = function events$4() {
  ...
  var setValue$2 = function setValue$2(component, repConfig, _repState, data) {
  ...
  var get$9 = function get$9(editor) {
  ...
  var field$2 = function field$2(name, placeholder) {
    var inputSpec = record(Input.sketch({
      ...
      onSetValue: function onSetValue(input$1, _data) {
        emit(input$1, input());
      },
      inputBehaviours: derive$1([Composing.config({
        find: Optional.some
  ...
  var exhibit$4 = function exhibit$4(base, disableConfig) {
    return nu$5({
  ...
  var make = function make(detail, components) {
    return {
      uid: detail.uid,
      dom: detail.dom,
      components: components,
  ...
  var sketch$6 = function sketch$6(rawSpec) {
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$1([orientation(function (dialog, message) {
  ...
  var parts$1 = constant([group({
    ...
    defaults: function defaults(detail, u) {
      return u.hasOwnProperty('uid') ? u : _assign(_assign({}, u), {
        uid: generate$3('item')
      });
    },
  ...
  var make$3 = function make$3(detail, _rawUiSpec) {
  ...
  var getState$1 = function getState$1(comp, transConfig, _transState) {
  ...
  var makeMenu = function makeMenu(value, items, memMenuThunk, collapsable) {
    return {
      ...
      components: [Button.sketch({
        ...
        behaviours: derive$1([config('adhoc-scrollable-menu', [runOnAttached(function (component, _simulatedEvent) {
  ...
  var setup = function setup(realm, editor) {
    ...
    var styleselect = function styleselect() {
      return forToolbar('style-formats', function (button) {
        ...
        channels: wrapAll$1([receive$1(orientationChanged, Toggling.off), receive$1(dropupDismissed, Toggling.off)])
      })]), editor);
    };
  ...
  var detect$4 = function detect$4(editor, features) {
  ...
  var get$c = function get$c(outerWindow) {
  ...
  var initEvents = function initEvents(editorApi, toolstrip, alloy) {
    ...
    }), tapping.onTouchmove(), tapping.onTouchend(), bind$3(toolstrip, 'touchstart', function (_evt) {
    ...
    })].concat(isAndroid6 === true ? [] : [bind$3(SugarElement.fromDom(editorApi.win), 'blur', function () {
  ...
  var first$1 = function first$1(fn, rate) {
    var timer = null;
  ...
  var sketch$9 = function sketch$9(onView, _translate) {
  ...
  }), defaulted$1('translate', identity), defaulted$1('setReadOnly', noop), defaulted$1('readOnlyOnInit', always)]);
  ...
  var factory$4 = function factory$4(detail, components, _spec, _externals) {
  ...
  var factory$5 = function factory$5(detail, components, _spec, _externals) {
    return {
      uid: detail.uid,
      dom: detail.dom,
      components: components,
  ...
  var exhibit$5 = function exhibit$5(base, slideConfig, _slideState) {
  ...
  var initEvents$1 = function initEvents$1(editorApi, iosApi, toolstrip, socket, _dropup) {
