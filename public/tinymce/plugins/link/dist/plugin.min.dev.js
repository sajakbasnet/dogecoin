...
!function () {
  ...
  var n,
    ...
    return t && "FIGURE" === t.nodeName && /\bimage\b/i.test(t.className);
      ...
      et = function et(t) {
    return n = ["title", "rel", "class", "target"], e = function e(n, _e) {
      return t[_e].each(function (t) {
        n[_e] = 0 < t.length ? t : null;
      }), n;
    }, r = {
      href: t.href
    }, function (t, n) {
    ...
    var u = {
      ...
      return r.isSome() || o.isSome() ? N.some(_q(_q({}, r.map(function (t) {
        return {
          text: t
        };
    ...
    return R([pt, (e = g(u), r = u.getParam("link_default_protocol", "http", "string"), function (t) {
      ...
      return new ht(function (n) {
        var e, t, r, o;
        e = u, t = i.message, r = function r(t) {
    ...
    (n = Q(t = h), At(t, n)).then(function (t) {
      ...
      return e = function e(t) {
        ...
        var n = function n(_n) {
          return N.from(e[_n]).filter(function (t) {
            return !u.anchor[_n].is(t);
          });
        },
            r = {
          href: e.url.value,
