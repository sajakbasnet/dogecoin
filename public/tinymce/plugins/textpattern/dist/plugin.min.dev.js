  ...
  var n,
    ...
    var a = function a(t) {
      return D.error({
        ...
        t = function t(_t, n, r) {
      if (o.format === undefined) return o.cmd !== undefined ? g(o.cmd) ? D.value(r(o.cmd, o.value)) : a(_t + " pattern has non-string `cmd` parameter") : a(_t + " pattern is missing both `format` and `cmd` parameters");
      var e = void 0;

      if (h(o.format)) {
        if (!R(o.format, g)) return a(_t + " pattern has non-string items in the `format` array");
        e = o.format;
      } else {
        if (!g(o.format)) return a(_t + " pattern has non-string `format` parameter");
        e = [o.format];
      }
    ...
    return it(l, d - u.pattern.end.length, i).bind(function (t) {
      ...
      return function (t, r, n, e, o, a) {
        ...
        var n,
            r = st(c, (n = t).startContainer, n.startOffset, n.endContainer, n.endOffset);
        return {
    ...
    var n,
        r,
        a = (n = "mce_textpattern", r = new Date().getTime(), n + "_" + Math.floor(1e9 * Math.random()) + ++ht + String(r)),
        i = E(t, function (t, n) {
