...
(function () {
  ...
  var get$1 = function get$1(patternsState) {
  ...
  var applyPattern = function applyPattern(editor, match) {
    var dom = editor.dom;
  ...
  var findPattern = function findPattern(patterns, text) {
  ...
  var findPatterns = function findPatterns(editor, patterns) {
    var dom = editor.dom;
  ...
  var findPattern$1 = function findPattern$1(editor, block, details) {
    var dom = editor.dom;
  ...
  var applyPattern$1 = function applyPattern$1(editor, pattern, patternRange) {
  ...
  var findPatterns$1 = function findPatterns$1(editor, patterns, space) {
    var rng = editor.selection.getRng();
