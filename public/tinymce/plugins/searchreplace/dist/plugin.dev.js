...
(function () {
  ...
  var find = function find(text, pattern, start, finish) {
    if (start === void 0) {
      start = 0;
    }
  ...
  var find$2 = function find$2(editor, currentSearchState, text, matchCase, wholeWord, inSelection) {
  ...
  var get$1 = function get$1(editor, currentState) {
    var done$1 = function done$1(keepEditorSelection) {
      return done(editor, currentState, keepEditorSelection);
    };

    var find = function find(text, matchCase, wholeWord, inSelection) {
