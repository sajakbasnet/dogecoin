...
!function () {
  ...
  var e,
    ...
    var t,
      ...
      onAction: function onAction(e, n) {
        "results" === n.name && (s(r, n.value), e.close());
      },
      onTabChange: function onTabChange(e, n) {
  ...
  a.add("charmap", function (e) {
    ...
    return r = c, (n = e).addCommand("mceShowCharmap", function () {
      ...
      columns: "auto",
      minChars: 2,
      fetch: function fetch(r, e) {
        return new P(function (e, n) {
          e(S(i, r));
        });
      },
      onAction: function onAction(e, n, r) {
