...
!function () {
  ...
  !function (n, t, a, d) {
    ...
    window.Prism = {
      ...
      "object" == _typeof(t) && void 0 !== a ? a.exports = e() : "function" == typeof n && n.amd ? n([], e) : ("undefined" != typeof window ? window : void 0 !== y ? y : "undefined" != typeof self ? self : this).EphoxContactWrapper = e();
    }(function () {
              ...
              var e = function (u) {
                var c = /\blang(?:uage)?-([\w-]+)\b/i,
                    ...
                    clone: function i(e, t) {
                      ...
                      switch (t = t || {}, C.util.type(e)) {
                        case "Object":
                          ...
                          for (var r in a = {}, t[n] = a, e) {
                            e.hasOwnProperty(r) && (a[r] = i(e[r], t));
                          }
                  ...
                  tokenize: function tokenize(e, n) {
                    ...
                    var r = new s();
                    return T(r, r.head, e), function E(e, n, t, a, r, s) {
                      for (var i in t) {
                            ...
                            for (var f = c.pattern || c, b = a.next, h = r; b !== n.tail && !(s && h >= s.reach); h += b.value.length, b = b.next) {
                              ...
                              if (!(y instanceof O)) {
                                ...
                                if (g) {
                                  ...
                                  for (x += b.value.length; x <= k;) {
                                    b = b.next, x += b.value.length;
                                  }

                                  if (x -= b.value.length, h = x, b.value instanceof O) continue;

                                  for (var P = b; P !== n.tail && (x < _ || "string" == typeof P.value); P = P.next) {
                                    v++, x += P.value.length;
                                  }
            ...
            buildPlaceholders: {
              value: function value(a, r, e, s) {
                ...
                a.language === r && (i = a.tokenStack = [], a.code = a.code.replace(e, function (e) {
                  ...
                  for (var n, t = i.length; -1 !== a.code.indexOf(n = h(r, t));) {
                    ++t;
                  }
  ...
  var w = h.exports.boltExport,
    ...
    a.ui.registry.addToggleButton("codesample", {
      ...
      onSetup: function onSetup(t) {
        ...
        return a.on("NodeChange", e), function () {
