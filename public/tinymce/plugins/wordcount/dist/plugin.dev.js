...
(function () {
  ...
  var removeZwsp = function removeZwsp(s) {
    return s.replace(/\uFEFF/g, '');
  };
  ...
  var getWords = function getWords(chars, extract, options) {
  ...
  var register = function register(editor, api) {
