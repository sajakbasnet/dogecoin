...
(function () {
  ...
  var contains$2 = function contains$2(e1, e2) {
  ...
  var rowdata = function rowdata(element, cells, section) {
    return {
      element: element,
      cells: cells,
      section: section
  ...
  var rowdatanew = function rowdatanew(element, cells, section, isNew) {
    return {
      element: element,
      cells: cells,
      section: section,
  ...
  var rowcells = function rowcells(cells, section) {
    return {
      cells: cells,
      section: section
    };
  ...
  var rowdetails = function rowdetails(details, section) {
    return {
      details: details,
      section: section
    };
  ...
  var eq$2 = function eq$2(universe, item) {
  ...
  var columns$1 = function columns$1(warehouse, isValidCell) {
  ...
  var getPercentSize = function getPercentSize(elm, getter) {
  ...
  var isPercentSizing = function isPercentSizing(table) {
    return getRawWidth(table).exists(function (size) {
      return rPercentageBasedSizeRegex.test(size);
    });
  };

  var isPixelSizing = function isPixelSizing(table) {
    return getRawWidth(table).exists(function (size) {
      return rPixelBasedSizeRegex.test(size);
    });
  };

  var isNoneSizing = function isNoneSizing(table) {
  ...
  var hasRawStyle = function hasRawStyle(cell, prop) {
  ...
  var percentageSize = function percentageSize(initialWidth, table) {
  ...
  var pixelSize = function pixelSize(initialWidth, table) {
  ...
  var fromDom$1 = function fromDom$1(nodes) {
  ...
  var getRawWidth$1 = function getRawWidth$1(editor, elm) {
  ...
  var paste$1 = function paste$1(element, clipboard, generators) {
    return {
      element: element,
      clipboard: clipboard,
  ...
  var adjustAndRedistributeWidths = function adjustAndRedistributeWidths(_table, list, details, tableSize, resizeBehaviour) {
  ...
  var Size = _assign(_assign({}, adt$1), {
    from: from$1
  });
  ...
  var redistribute = function redistribute(widths, totalWidth, newWidth) {
  ...
  var add = function add(value, amount) {
  ...
  var redistribute$1 = function redistribute$1(table, optWidth, optHeight, tableSize) {
    var warehouse = Warehouse.fromTable(table);
  ...
  var create = function create(typeDefs) {
  ...
  var transform = function transform(mutation, settings) {
    if (settings === void 0) {
      settings = {};
    }
  ...
  var create$1 = function create$1(wire, resizing, lazySizing) {
  ...
  var convertToPercentSize = function convertToPercentSize(table, tableSize) {
    var newWidth = getPercentTableWidth(table);
    redistribute$1(table, Optional.some(newWidth), Optional.none(), tableSize);
    cleanupLegacyAttributes(table);
  };

  var convertToPixelSize = function convertToPixelSize(table, tableSize) {
  ...
  var scan = function scan(universe, element, direction) {
  ...
  var freefallRtl = function freefallRtl(universe, element) {
  ...
  var freefallRtl$2 = function freefallRtl$2(element) {
  ...
  var insert = function insert(table, selector, element) {
  ...
  var onUnlockedCell = function onUnlockedCell(warehouse, target) {
  ...
  var getValidStartAddress = function getValidStartAddress(currentStartAddress, grid, lockedColumns) {
    ...
    return _assign(_assign({}, currentStartAddress), {
  ...
  var transform$1 = function transform$1(scope, tag) {
  ...
  var opMakeRowHeader = function opMakeRowHeader(grid, detail, comparator, genWrappers) {
  ...
  var opGetColumnType = function opGetColumnType(table, target) {
    var house = Warehouse.fromTable(table);
  ...
  var getCellsType = function getCellsType(cells, headerPred) {
  ...
  var getSection = function getSection(elm) {
    return getNodeName(elm.parentNode);
  };

  var mapSectionNameToType = function mapSectionNameToType(section) {
    if (section === 'thead') {
      return 'header';
  ...
  var detectHeaderRow = function detectHeaderRow(editor, elm) {
  ...
  var getRowType = function getRowType(editor, elm) {
  ...
  var switchRowSection = function switchRowSection(dom, rowElm, newSectionName) {
  ...
  var renameCell = function renameCell(editor, cell, newCellType) {
  ...
  var switchCellType = function switchCellType(editor, cell, newCellType, scope) {
    var dom = editor.dom;
  ...
  var switchCellsType = function switchCellsType(editor, cells, newCellType, scope) {
    return each(cells, function (c) {
      return switchCellType(editor, c, newCellType, scope);
    });
  };

  var switchSectionType = function switchSectionType(editor, rowElm, newType) {
    var determineHeaderRowType = function determineHeaderRowType() {
  ...
  var getSelectionStartCellFallback = function getSelectionStartCellFallback(start) {
  ...
  var getCellsFromSelection = function getCellsFromSelection(start, selections) {
    return getSelectionStartCell(start).map(function (_cell) {
      return selection(selections);
    }).getOr([]);
  };

  var getRowsFromSelection = function getRowsFromSelection(start, selector) {
  ...
  var TableActions = function TableActions(editor, lazyWire, selections) {
    ...
    var setTableCellType = function setTableCellType(editor, args) {
    ...
    var setTableRowType = function setTableRowType(editor, args) {
    ...
    var getTableCellType = function getTableCellType(editor) {
  ...
  var render$1 = function render$1(rows, columns, rowHeaders, columnHeaders, headerType, renderOpts) {
  ...
  var isPercentage$1 = function isPercentage$1(width) {
    return isString(width) && width.indexOf('%') !== -1;
  };

  var insert$1 = function insert$1(editor, columns, rows, colHeaders, rowHeaders) {
  ...
  var buildListItems = function buildListItems(inputList, startItems) {
    var appendItems = function appendItems(values, acc) {
  ...
  var getSelectedCells = function getSelectedCells(cells) {
    return table(cells[0]).map(function (table) {
      var warehouse = Warehouse.fromTable(table);
  ...
  var updateSimpleProps = function updateSimpleProps(modifier, colModifier, data) {
  ...
  var open = function open(editor, selections) {
  ...
  var updateSimpleProps$1 = function updateSimpleProps$1(modifier, data) {
    modifier.setAttrib('class', data["class"]);
    modifier.setStyle('height', addPxSuffix(data.height));
  };
  ...
  var getItems$2 = function getItems$2(editor, classes, insertNewTable) {
  ...
  var getSelectionStartCellOrCaption$1 = function getSelectionStartCellOrCaption$1(editor) {
    return getSelectionStartCellOrCaption(getSelectionStart(editor));
  };

  var getSelectionStartCell$1 = function getSelectionStartCell$1(editor) {
  ...
  var Clipboard = function Clipboard() {
    ...
    var clearClipboard = function clearClipboard(clipboard) {
  ...
  var none$2 = function none$2(current) {
    if (current === void 0) {
      current = undefined;
    }
  ...
  var CellLocation = _assign(_assign({}, adt$2), {
    none: none$2
  });

  var detect$5 = function detect$5(current, isRoot) {
  ...
  var forward = function forward(editor, isRoot, cell, actions) {
    return go(editor, isRoot, next(cell), actions);
  };

  var backward = function backward(editor, isRoot, cell, actions) {
  ...
  var go = function go(editor, isRoot, cell, actions) {
  ...
  var handle$1 = function handle$1(event, editor, actions) {
  ...
  var create$3 = function create$3(selection, kill) {
    return {
      selection: selection,
      kill: kill
    };
  ...
  var detect$6 = function detect$6(container, isRoot, start, finish, selectRange) {
    if (!eq$1(start, finish)) {
  ...
  var BeforeAfter = _assign(_assign({}, adt$6), {
    verify: verify,
    cata: cata$2
  });
  ...
  var scan$1 = function scan$1(bridge, isRoot, element, offset, direction, numRetries) {
    if (numRetries === 0) {
      return Optional.none();
    }
  ...
  var getSelectionTargets = function getSelectionTargets(editor, selections) {
    var _targets2 = Cell(Optional.none());
    ...
    var resetTargets = function resetTargets() {
      _targets2.set(cached(findTargets)());

      selectionDetails = _targets2.get().bind(getExtractedDetails);
    ...
    var onSetup = function onSetup(api, isDisabled) {
      var handler = function handler() {
        return _targets2.get().fold(function () {
    ...
    return {
      ...
      targets: function targets() {
        return _targets2.get();
      }
    };
  };

  var addButtons = function addButtons(editor, selectionTargets, clipboard) {
  ...
  var addMenuItems = function addMenuItems(editor, selectionTargets, clipboard) {
    var cmd = function cmd(command) {
      return function () {
        return editor.execCommand(command);
      };
