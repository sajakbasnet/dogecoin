...
!function () {
  ...
  var e,
    ...
    return e[e.length - 1];
      ...
      _e3 = function _e() {
    return (_e3 = Object.assign || function (e) {
  ...
  var Re,
    ...
    return null === e || e === undefined ? "" : ("" + e).replace(St, "");
      ...
      Et = function Et(e, t) {
    return t ? !("array" !== t || !be(e)) || _typeof(e) === t : e !== undefined;
  },
      kt = function kt(e, n, r, o) {
  ...
  Oe = undefined, Be = cr, Pe = lr, Le = undefined, function (e) {
    "object" == _typeof(Be) && void 0 !== Pe ? Pe.exports = e() : "function" == typeof Oe && Oe.amd ? Oe([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = e();
  }(function () {
  ...
  var Nr,
    ...
    return Sr(Dt, Br, e, t, n);
      ...
      Ir = window.Promise ? window.Promise : (Nr = function Nr(n, r) {
    return function () {
      for (var e = [], t = 0; t < arguments.length; t++) {
        e[t] = arguments[t];
      }
    ...
    return new kr(function (o, i) {
      ...
      for (var a = s.length, u = function u(t, e) {
        try {
          if (e && ("object" == _typeof(e) || "function" == typeof e)) {
            var n = e.then;
            if ("function" == typeof n) return void n.call(e, function (e) {
    ...
    return t && "object" == _typeof(t) && t.constructor === kr ? t : new kr(function (e) {
      e(t);
    });
  ...
  var Hr,
    ...
    var g = 0,
      ...
      t && i.passed.push(t), _n2 && i.failed.push(_n2), 1 !== i.status && (2 !== i.status ? 3 !== i.status ? (i.status = 1, a = Rt.fromTag("link", y.dom), Gn(a, {
        rel: "stylesheet",
        type: "text/css",
        id: i.id
  ...
  var Jr,
    ...
    if (e) {
      for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2) {
        r = String.fromCharCode(parseInt(e[n], t)), ri[r] || (o = "&" + e[n + 1] + ";", i[r] = o, i[o] = r);
      }
    ...
    var e,
      ...
      return r ? r = mi(r, /[, ]/, mi(r.toUpperCase(), /[, ]/)) : (r = fi[e]) || (r = mi(t, " ", mi(t.toUpperCase(), " ")), r = gi(r, n), fi[e] = r), r;
        ...
        g = (e = (i = i || {}).schema, c = {}, u = function u(e, t, n) {
      var r,
          o,
          i = function i(e, t) {
        for (var n = {}, r = 0, o = e.length; r < o; r++) {
        ...
        for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = x.length; t < n; t++) {
          if (i = b.exec(x[t])) {
            if (p = i[1], c = i[2], g = i[3], s = i[5], a = {
              ...
              d[t] = e;
            }), m.push.apply(m, v)), s) for (r = 0, o = (s = yi(s, "|")).length; r < o; r++) {
              if (i = C.exec(s[r])) {
    ...
    for (var t = ("\\\" \\' \\; \\: ; : " + k).split(" "), _ = 0; _ < t.length; _++) {
      E[t[_]] = k + _, E[k + _] = t[_];
    }
  ...
  var Oi,
    ...
    return e === t && (ji = !0), 0;
      ...
      ra = typeof undefined === "undefined" ? "undefined" : _typeof(undefined),
      oa = {}.hasOwnProperty,
      ia = [],
      aa = ia.pop,
      ua = ia.push,
  ...
  var Ha = document,
    ...
    if (Ya(t)) t = Ga(t, fu(e[0]));else if (t.length && !t.nodeType) {
      if (t = gu.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) {
        Ja(e, t[o], n, r);
  ...
  au.fn = au.prototype = {
    ...
    add: function add(e, t) {
      ...
      if (!1 !== t) for (n = gu.unique(this.toArray().concat(gu.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) {
        this[r] = n[r];
  ...
  var gu = au,
    ...
    var n,
      ...
      createHTML: function createHTML(e, t, n) {
        ...
        for (r in o += "<" + e, t) {
          t.hasOwnProperty(r) && null !== t[r] && "undefined" != typeof t[r] && (o += " " + r + '="' + I(t[r]) + '"');
        }
  ...
  var Au = function Au(e) {
    ...
    var o = [],
      ...
      return "object" == _typeof(t) ? t : "string" == typeof e ? {
        ...
        d = function d(o, i, a, u, e) {
      var t, n;
      r[o] || (0 !== (t = "string" == typeof i ? i : i.prefix + i.resource + i.suffix).indexOf("/") && -1 === t.indexOf("://") && (t = Bu.baseURL + "/" + t), r[o] = t.substring(0, t.lastIndexOf("/")), n = function n() {
        var n, e, t, r;
      ...
      void 0 === n && (n = "added"), ve(s, _e6) && "added" === n || ve(r, _e6) && "loaded" === n ? t() : i.push({
        name: _e6,
        state: n,
        callback: t
      });
  ...
  var Ms,
    ...
    for (Mn(a) ? s.push(n ? function (e, t, n) {
      for (var r = e(t.data.slice(0, n)).length, o = t.previousSibling; o && Mn(o); o = o.previousSibling) {
        r += e(o.data).length;
      }
    ...
    return {
      ...
      _c = function _c(e) {
    for (var t; -1 !== (t = e.data.lastIndexOf(mo));) {
      e.deleteData(t, 1);
    }
  },
      Ac = function Ac(e, t) {
  ...
  var ll,
    ...
    var r,
        ...
        u = n.startOffset,
        s = n.startContainer;
    if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType) for (u < (i = s.childNodes).length ? (s = i[u], r = new Yr(s, e.getParent(s, e.isBlock))) : (s = i[i.length - 1], (r = new Yr(s, e.getParent(s, e.isBlock))).next(!0)), o = r.current(); o; o = r.next()) {
  ...
  var Jf = function Jf(e, t) {
    ...
    l.on("init", function () {
      ...
      a(), (xt.browser.isIE() || xt.browser.isEdge()) && (l.on("mousedown click", function (e) {
        ...
        if (i(_e7.target) || Wn(_e7.target)) return _e7.preventDefault(), void t(_e7.target);
  ...
  Object.freeze({
    ...
    return cn(n.element, r), Ed(r, function () {
      ...
      _d = function _d(n, r, o, i) {
    Dd(n, function (e, t) {
      return Rd(n, r, o, i);
    }, o);
  },
      Ad = function Ad(e, t, n, r, o) {
    var i,
        a,
        u = {
      elm: r.element.dom,
    ...
    if (this.firstChild) {
      for (var e = [], t = this.firstChild; t; t = km(t, this)) {
        e.push(t);
      }
  ...
  var Tm = function Tm(e, t) {
    ...
    var X = W.comment ? W.comment : te,
      ...
      for (var t, i, n, d, r, o, a, m, u, s, c, l, p, g, h, v, y, b, C, w = f.html, x = 0, S = [], N = 0, E = li.decode, k = _t.makeMap("src,href,data,background,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, A = "html" === e ? 0 : 1, R = function R(e) {
  ...
  var Lm,
    ...
    for (var d = f.getShortEndedElements(); i = l.exec(c);) {
      r = l.lastIndex, o = i[0].length, n = d[i[1]] ? r : Pm.findEndTag(f, c, r), c = c.substring(0, r - o) + c.substring(n), l.lastIndex = r - o;
    }

    return go(c);
  },
      Fm = Mm,
      Um = function Um(e, t, n, r) {
    var o, i, a, u, s;
    ...
    return {
      compare: function compare(e, t) {
        ...
        var n = function n(_n3) {
          var r = {};
          return zm(o.getAttribs(_n3), function (e) {
            var t = e.nodeName.toLowerCase();
    ...
    var n,
        ...
        u = Kt(e).filter(zt),
        s = Xt(e).filter(zt);
    return gn(e), r = s, o = t, i = function i(e, t, n) {
      var r = e.dom,
          o = t.dom,
          i = r.data.length;
    ...
    var r = e.dom,
        o = e.selection;
    if (t) ch(e, t, n);else if (!(t = Ul(e.getBody(), o.getStart()))) for (; t = r.get(ih);) {
      ch(e, t, !1);
    }
  },
      fh = function fh(e, t) {
  ...
  var bh = _t.each,
    ...
    var e,
      ...
      T(d), Df(S, e, function (e) {
        var u,
          ...
          if (Rn(e) && S.getContentEditable(e) && (n = l, l = "true" === S.getContentEditable(e), t = !0), jn(e) && !function (e, t, n, r) {
            if (e.getParam("format_empty_lines", !1, "boolean") && pf(t)) {
              var o = _e3(_e3({}, e.schema.getTextBlockElements()), {
                td: {},
                th: {},
                li: {},
                dt: {},
        ...
        }), c = S, f = _, d = e, (l = R).styles && l.styles.backgroundColor && Nh(d, Eh(c, "fontSize"), kh(c, "backgroundColor", of(l.styles.backgroundColor, f))), i = S, u = e, s = function s(e) {
          var t;
    ...
    return vv((g = e, n = (p = o).length + g.length + 2, h = new Array(n), v = new Array(n), _c2 = function c(e, t, n, r, o) {
      var i = l(e, t, n, r);
      ...
      Cv = function Cv(n) {
    var e,
        t = (e = n.getBody(), H(z(ie(e.childNodes), gv), function (e) {
      return 0 < e.length;
    })),
        r = J(t, function (e) {
    ...
    return he(e.plugins, "rtc").fold(function () {
      ...
      return U.some(e.setup().then(function (e) {
        var t, o, n, i, a, r, u, s;
        return c.rtcInstance = (o = function o(e) {
          return k(e) ? e : {};
    ...
    i.no_events || !(i = e.fire("BeforeSetContent", i)).isDefaultPrevented() ? (n.content = function (e, t) {
      ...
      var n = e.selection.getRng(),
        ...
        context: r.nodeName.toLowerCase()
          ...
          i = e.parser.parse(t.content, _e3(_e3({
        isRootContent: !0,
        forced_root_block: !1
      }, o), t));
      return qm({
  ...
  var Fv,
      ...
      getSelectedBlocks: function getSelectedBlocks(e, t) {
        return function (e, t, n, r) {
          var o,
              i = [],
              a = e.getRoot();
          if (n = e.getParent(n || wm(a, t, t.collapsed), e.isBlock), r = e.getParent(r || xm(a, t, t.collapsed), e.isBlock), n && n !== a && i.push(n), n && r && n !== r) for (var u = new Yr(o = n, a); (o = u.next()) && o !== r;) {
    ...
    var i = o.blob_cache,
      ...
      (e = _t3).attr("src") === xt.transparentSrc || e.attr("data-mce-placeholder") || _t3.attr("data-mce-bogus") || ((n = /data:([^;]+);base64,([a-z0-9\+\/=]+)/i.exec(r)) ? U.some({
        type: n[1],
    ...
    return o = n, (r = e) && r.hasEventListeners("PreProcess") && !o.no_events ? function (e, t, n) {
      ...
      }), t = "BODY" !== t.nodeName ? r.body.firstChild : r.body, o = i.doc, i.doc = r), a = e, u = _e3(_e3({}, n), {
        node: t
    ...
    return a = e, s = f, (u = o).no_events || !a ? s : (c = a, l = _e3(_e3({}, u), {
      content: s
    ...
    return By(Sy || Ny, Sy, c, r, o);
      ...
      Ly = function Ly(e, t, n) {
    return U.from(t.settings[n]).filter(e);
  },
      Iy = function Iy(e, t, n, r) {
    var o,
        i,
        a,
    ...
    var t,
      ...
      if (void 0 === e && (e = !0), !n.removed && $y(n)) return e && n.fire("BeforeOpenNotification", {
        ...
        return e = t, o.push(e), u(), n.fire("OpenNotification", _e3({}, t)), t;
      });
    };
  ...
  var Yy,
    ...
    var o = {},
      ...
      return e = _t.grep(e, function (e) {
        ...
        return u.isPending(e.blobUri()) ? (n = e.blobUri(), new Ir(function (e) {
          o[n] = o[n] || [], o[n].push(e);
        })) : (i = e, t = s.handler, a = _r5, u.markPending(i.blobUri()), new Ir(function (r) {
          var n;
    ...
    return Lb(Rt.fromDom(e), Rt.fromDom(n.getNode())).map(function (e) {
      ...
      fC = function fC(u, s, c) {
    return Rl(s, u, c).bind(function (e) {
      return a = e.getNode(), so(Rt.fromDom(a)) || ao(Rt.fromDom(a)) ? U.none() : (t = u, o = e, i = function i(e) {
    ...
    a.on("touchstart", function (n) {
      ...
      r.cancel(), "touchcancel" !== t.type && u.get().filter(function (e) {
        ...
        s.get() ? t.preventDefault() : a.fire("tap", _e3(_e3({}, t), {
          type: "tap"
        }));
      });
    }, !0);
    ...
    t.hasAttribute("data-mce-caret") && (_o(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
      ...
      Rw = function Rw(e, t) {
    var n,
        r = (n = e, Pr(Rt.fromDom(n.getBody()), "*[data-mce-caret]").fold(S(null), function (e) {
      return e.dom;
    }));
  ...
  var Vw = function Vw(o, i, a, e, u, t) {
    var s = 0,
        c = [],
        n = function n(e) {
      var t,
    ...
    return J(e, function (e) {
      var t,
          n,
          r = (t = ss(e.getBoundingClientRect()), n = -1, {
        left: t.left - n,
        top: t.top - n,
        right: t.right + 2 * n,
        bottom: t.bottom + 2 * n,
    ...
    E && ((N && !y || !N && y) && (u = function (e, t, n, r, o) {
      ...
      if (!p || !nS(d, p)) {
        ...
        if (a && e.schema.isValidChild(c, f.toLowerCase())) {
          for (i = d.create(f), iS(e, i), a.parentNode.insertBefore(i, a), u = a; u && !d.isBlock(u);) {
  ...
  var VS = function VS(e) {
    ...
    }), i), t.serializer = dy((s = (a = t).settings, _e3(_e3({}, lN(a)), cN({
    ...
    e.fire("ScriptsLoaded"), n = e, t = _t.trim(mc(n)), r = n.ui.registry.getAll().icons, o = _e3(_e3({}, My.get("default").icons), My.get(t).icons), se(o, function (e, t) {
    ...
    var n,
        ...
        o,
        i,
        a = "string" != typeof (n = t) ? (r = _t.extend({
      paste: n.paste,
      data: {
        paste: n.paste
      }
      ...
      if (bc(i)) {
        ...
        e = function e(_e10) {
          for (var t = _e10.target, n = i.editorManager.get(), r = n.length; r--;) {
            var o = n[r].getBody();
            o !== t && !lE.isChildOf(t, o) || dE(n[r], a, _e10);
          }
    ...
    return (e = t).serializer ? nE(e) : e.on("PreInit", function () {
      ...
      register: function register(e, t) {
        o.set(function (e, t, n) {
          ...
          return _e3(_e3({}, e), ((r = {})[t] = _e3(_e3({}, n), {
  ...
  var EE = function EE() {
    var e,
      ...
      addButton: (u = function u(n, r) {
        return function (e, t) {
          return n[e.toLowerCase()] = _e3(_e3({}, t), {
            type: r
          });
        };
      })(e = {}, "button"),
  ...
  dk.extend = _tk = function tk(n) {
    var o = this.prototype,
        r = function r() {
      var e, t, n;
      if (!nk && (this.init && this.init.apply(this, arguments), t = this.Mixins)) for (e = t.length; e--;) {
    ...
    }), r.prototype = i, (r.constructor = r).extend = _tk, r;
  };
