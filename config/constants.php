...
return [
    ...
    'META' => ['meta' => [
        ...
        'site' => env('APP_URL'),
        'emails' => ['admin@gmail.com', 'admin@gmail.com'],
        'api' => [
            'version' => 1,
        ],
    ]],
    'FROM_MAIL' => env('MAIL_FROM_ADDRESS', 'admin@gmail.com'),
    'FROM_NAME' => env('MAIL_FROM_NAME', 'Dogecoin'),
    'DEFAULT_LOCALE' => env('DEFAULT_LOCALE', 'en'),
    'ADMIN_DEFAULT_EMAIL' => env('ADMIN_DEFAULT_EMAIL', 'admin@gmail.com'),
